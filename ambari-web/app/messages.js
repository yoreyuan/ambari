...
/** Chinese */
Em.I18n.translations.zh = {
  'app.name':'Ambari',
  'app.name.subtitle':'Ambari - {0}',
  'app.name.subtitle.experimental':'Ambari实验性的',
  'app.name.subtitle.installer':'群集安装向导',
  'app.reloadPopup.link': '重载页面',
  'app.reloadPopup.text': '尝试连接到服务...',
  'app.reloadPopup.noClusterName.text': '未能检索到集群名，尝试重新加载...',
  'app.reloadPopup.header': '重载页面',
  'app.redirectIssuePopup.header': '登录重定向问题',
  'app.redirectIssuePopup.body': '对于单点登录，请确保Knox网关和Ambari服务位于同一主机或子域中。' +
      '<br/>或者以Ambari本地用户的身份登录本地页面。<br />' +
      '<a rel="noopener noreferrer" href="{0}" target="_blank">{0}</a>',

  'app.loadingPlaceholder': '加载中...',
  'app.versionMismatchAlert.title': 'Ambari服务/Web客户端版本不匹配',
  'app.versionMismatchAlert.body': 'Ambari服务和Web客户端版本不匹配：<br> ' +
      '<br>Ambari Server: <strong>{0}</strong>' +
      '<br>Ambari Web Client: <strong>{1}</strong><br>' +
      '<br>这通常发生在升级Ambari之后，因为Ambari Web客户端代码缓存在浏览器中。' +
      '<br>强制执行浏览器缓存刷新，通常是\'Ctrl+Shift+R\'（在OS X中\'Cmd+Shift+R\'）, 查看此消息是否消失。' +
      '<br>如果您一直看到此消息，请完全清除浏览器缓存并再次点击此URL。' +
      '<br>必须解决此错误才能继续。',
  'app.signout':'登出',
  'app.settings':'设置',
  ...
  'app.settings.notShowBgOperations': '开始后台操作时不再显示此对话框',
  ...
  'app.settings.admin.all.privileges': '此用户为Ambari管理员，拥有所有权限。',
  ...
  'app.aboutAmbari.licensed': '根据Apache许可证2.0版本授权',
  ...
  'common.last':'最后的',
  'common.loadAvg':'平均负载',
  'common.components':'多组件',
  'common.component':'组件',
  'common.quickLinks':'快速链接',
  'common.save':'保存',
  'common.saveAnyway':'依然保存',
  'common.servers':'服务(s)',
  'common.clients':'客户端(s)',
  'common.all.clients':'所有的客户端',
  'common.user': '用户',
  'common.users': '用户们',
  'common.issues': '问题',
  'common.os':'OS',
  ...
  'common.pause':'暂停',
  'common.end':'结束',
  'common.decommission':'退服',
  'common.recommission':'入服',
  'common.failure': '失败',
  'common.type': '类型',
  'common.direction': '指导',
  'common.close': '关闭',
  ...
  'common.revert': '恢复',
  'common.errorPopup.header': '遇到了错误',
  'common.use': '使用',
  'common.stacks': '堆栈',
  'common.stack': '组件',
  'common.reset': '重置',
  ...
  'common.process': '进程',
  'common.property': '属性',
  'common.installed': '已安装的',
  'common.persist.error' : '在ambari服务器上持久化web客户端状态时出错。服务器响应如下错误消息：',
  ...
  'common.timeout.warning.popup.body.before': '您将自动登出 ',
  'common.timeout.warning.popup.body.after': ' 不活动的秒数',
  'common.timeout.warning.popup.primary': '保持登录状态',
  'common.timeout.warning.popup.secondary': '立即登出',
  'common.openNewWindow': '在新窗口中打开',
  'common.fullLogPopup.clickToCopy': '点击复制',
  'common.nothingToDelete': '无任何可删除的',
  'common.exclude': '排除',
  'common.include': '包含',
  ...
  'common.start.time': '启动时间',
  'common.end.time': '结束时间',
  'common.rolling': '回滚',
  'common.express': 'Express',
  'common.hostOrdered': 'Host Ordered',
  'common.repository': '资源库',
  'common.repositoryType': '资源库类型',
  'common.rolling.downgrade': '降级回滚',
  ...
  'common.configure.restart': '配置重启',

  'models.alert_instance.tiggered.verbose': "发生在{0} <br> 已检查{1}",
  ...
  'hostPopup.bgop.abortRequest.modal.body': '中断请求<strong>{0}</strong>已经发送到服务器。注意: 一些已经在运行的任务在应用中止请求之前的时间内可能完成或失败。',
  'hostPopup.bgop.sourceRequestSchedule.running': '该批处理请求的后续操作可以中止',
  'hostPopup.bgop.sourceRequestSchedule.aborted': '此批处理请求的后续操作已中止',
  'hostPopup.bgop.abort.rollingRestart': '中止滚动重启',
  'hostPopup.warning.alertsTimeOut': '维护模式已经转变为{0}，告警可能需要几分钟才能发出{1}。',
  'hostPopup.reccomendation.beforeDecommission': '{0}退服前需进行维护。',
  'hostPopup.setRackId.success': '将机架ID更新为\"{0}\", 它可能需要一些时间才能刷新。',
  'hostPopup.setRackId.error': '更新机架id失败。',
  'hostPopup.setRackId.invalid': '应该以正斜线开头，它可以包括字母数字字符、点、破折号和正斜杠，应少于255个符号。',
  'hostPopup.RackId': '机架',
  'hostPopup.recommendation.beforeDecommission': '{0}退服前需要采用维护方式。',
  'hostPopup.default.userName': 'none',
  ...
  'question.sure.move':'您确定要移除{0}吗？',
  'question.sure.refresh':'您确定要在{1}更新{0}吗？',
  'question.sure.maintenance':'您确定要为{1}打开{0}维护模式吗？',
  'question.sure.upgrade':'您确定要升级{0}吗？',
  'question.sure.decommission':'您确定要退服{0}吗？',
  'question.sure.recommission':'您确定入服{0}吗？',
  'question.sure.startAll':'您确定要启动所有组件吗？',
  'question.sure.stopAll':'您确定要停止所有组件吗？',
  'question.sure.restartAll':'您确定要重启所有组件吗？',
  'question.sure.regenerateKeytab.service': '您确定要为{0}服务重新生成keytab文件操作吗？',
  'question.sure.regenerateKeytab.host': '您确定要为{0}主机重新生成keytab文件操作吗？',

  'popup.highlight':'点击高亮',
  'popup.confirmation.commonHeader':'确认',
  'popup.confirmation.refreshYarnQueues.body':'强烈建议在修改容量调度器配置后，<strong>刷新Yarn队列</strong>。您要继续吗？',
  'popup.warning.refreshYarnQueues.body': '<div class="alert alert-warning"><strong>警告：</strong>队列配置更改可能已影响Hive LLAP使用的队列。可能需要重新配置或重新启动Hive LLAP。</div>',
  'popup.confirmation.refreshYarnQueues.buttonText':'刷新Yarn队列',
  'popup.confirmation.hsiRestart.body':'强烈建议在更改Hive LLAP大小配置后<strong>重启HiveServer2 Interactive</strong> ，您要继续吗？',
  ...
  'popup.clusterCheck.Upgrade.fail.alert': '您<strong>必须</strong>先满足这些要求然后再继续。',
  'popup.clusterCheck.Upgrade.fail.auto_start_disabled': '执行升级前必须禁用自动启动。',
  ...
  'popup.clusterCheck.Upgrade.fail.maintanance': '以下主机不能处于“维护模式”，因为主机上有主组件：',
  'popup.clusterCheck.Upgrade.fail.maintanance.action_btn': '关闭维护模式',
  'popup.clusterCheck.Upgrade.fail.atlasInstalled.action_btn': '移除Atlas',
  'popup.clusterCheck.Upgrade.fail.atlasInstalled': 'Atlas应该被移除。',
  'popup.clusterCheck.Upgrade.services.checks' : '服务检查',
  'popup.clusterCheck.Upgrade.bypassed-failures.title': '错误可以忽略',
  'popup.clusterCheck.Upgrade.bypassed-failures.alert': '由于stack.upgrade.bypass.prechecks设置为true，因此可以忽略错误，强烈建议您查看这些失败。',
  'popup.clusterCheck.Upgrade.warning.title': '警告',
  'popup.clusterCheck.Upgrade.warning.alert': '不需要修正警告，但<strong>推荐</strong>修正。',
  'popup.clusterCheck.Upgrade.configsMerge.title': '配置变更',
  'popup.clusterCheck.Upgrade.configsMerge.alert': '升级期间，将应用以下配置变更。',
  ...
  'popup.clusterCheck.Upgrade.configsRecommend.alert': '我们检查到需要更新以下属性，' +
      ' 但由于对其进行了自定义，因此无法自动进行。  请手动检查这些属性，' +
      ' 并在必要时手动更新这些属性。',
  'popup.clusterCheck.Upgrade.configsRecommend.title': '推荐的配置更改：手动检查',
  'popup.clusterCheck.Security.header': '启用安全',
  'popup.clusterCheck.Security.title': '不满足安全要求',
  'popup.clusterCheck.Security.alert': '您必须先满足以下要求，然后才能启用安全。',

  'popup.invalid.KDC.header': 'Admin会话过期的错误',
  ...
  'popup.dependent.configs.title.values': 'Ambari会将所有选中的配置更新为<b>推荐值</b>。取消选中任何配置以保留<b>当前值</b>。</b>.',
  'popup.dependent.configs.title.required': '需要进行以下配置更改，这些更改将自动应用。',
  'popup.dependent.configs.table.recommended': '建议的变更',
  'popup.dependent.configs.table.required': '必要的变更',
  ...
  'popup.dependent.configs.select.config.group': '请选择要将相关属性保存到的配置组',

  'popup.dependent.configs.dependencies.config.singular': '有{0}配置更改 ',
  'popup.dependent.configs.dependencies.config.plural': '有些{0}配置更改 ',
  'popup.dependent.configs.dependencies.service.singular': '在{0}服务',
  'popup.dependent.configs.dependencies.service.plural': '在{0}服务',

  'popup.dependent.configs.dependencies.for.groups': '您正在更改非默认组，请选择要从其他服务的相关配置保存到的配置组',

  'popup.jdkValidation.header': '不支持的JDK',
  'popup.jdkValidation.body': 'The {0} Stack要求JDK {1}，但是Ambari配置了{2}, 这可能会导致错误或运行群集的问题。',
  ...
  'login.error.bad.connection':'无法连接到Ambari服务，请确认Ambari服务正在运行，您可以从此计算机访问Ambari服务。',
  ...
  'graphs.noDataAtTime.message': '该时间段内无可用数据。',
  ...
  'services.hdfs.rebalance.title' : 'HDFS重平衡',
  'services.ganglia.description':'Ganglia指标收集系统',
  'services.hdfs.description':'Apache Hadoop分布式文件系统',
  'services.glusterfs.description':'Apache Hadoop Compatible文件系统必须手动安装）',
  'services.sqoop.description':'用于在Apache Hadoop和结构化数据存储（如关系型数据库）之间传输大量数据的工具',
  'services.pig.description':'用于分析大型数据集的脚本平台',
  'services.hive.description':'数据仓库系统，用于大型数据集的ad-hoc查询和分析，以及表和存储管理服务',
  'services.oozie.description':'用于工作流协调和执行Apache Hadoop作业的系统',
  'services.zookeeper.description':'可提供高可靠的分布式协调的集中式服务',
  'services.hbase.description':'非关系型分布式数据库和集中式配置管理和同步服务',
  'services.hive.databaseComponent':'数据库服务',
  'services.mapreduce2.description':'Apache Hadoop下一代MapReduce（客户端库）',
  ...
  'services.storm.configs.range-plugin-enable.dialog.message': '为STORM启用Ranger插件，仅在受保护的集群上有效。',


  'services.alerts.head':'您有一个{0}严重告警通知。',
  ...
  'services.alerts.OK.timePrefix': '{0}OK',
  ...
  'services.summary.allHostsAlreadyRunComponent': '所有已经运行{0}组件的主机',
  ...
  'installer.controls.serviceConfigPopover.title':'{0}<br><small>{1}</small>',
  'installer.controls.checkConnection.popover':'此操作将检查Ambari服务器主机{0}的主机和端口的可访问性',
  'installer.controls.serviceConfigMultipleHosts.other':'另一个',
  'installer.controls.serviceConfigMultipleHosts.others':'其它{0}',
  'installer.controls.serviceConfigMasterHosts.header':'{0}主机',
  'installer.controls.slaveComponentChangeGroupName.error':'具有该名称的组已经存在',

  'installer.step0.header':'开始使用',
  'installer.step0.body.header':'开始使用',
  'installer.step0.body':'该向导将引导您完成集群安装过程，首先从命名新群集开始。',
  'installer.step0.clusterName':'为您的集群命名',
  'installer.step0.clusterName.tooltip.title':'集群名',
  'installer.step0.clusterName.tooltip.content':'输入唯一的集群名称。',
  'installer.step0.clusterName.error.required':'集群名称为必填项',
  'installer.step0.clusterName.error.tooLong':'集群名太长',
  'installer.step0.clusterName.error.whitespace':'集群名不能包含空格',
  'installer.step0.clusterName.error.specialChar':'集群名称不能包含特殊字符',

  'installer.step1.header':'选择版本',
  'installer.step1.body':'选择群集的软件版本和交付方式。',
  'installer.step1.repo.body':'使用公共资源库需要Internet连接，使用本地资源库要求您已在可用的网络存储库中配置了软件。',
  'installer.step1.addVersion.title':'新增版本',
  ...
  'installer.step1.selectUseRepoOptions.public.networkLost':'为什么没选择呢？',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.title': '公共资源库选项没有选择',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg': 'Ambari无法确认对公共资源库的访问，这意味着您可能无法访问Internet，并且将无法使用“公共资源库”选项来安装软件。您的选择：',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg1': '配置主机以访问Internet。',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg2': '如果您使用的是Internet代理，请参阅Ambari文档以了解如何配置Ambari。',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg3': '使用本地资源库选项。',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg4': '如果您没有Internet访问权限并选择此选项，则将使基础资源库URL验证失败。',
  'installer.step1.selectUseRepoOptions.public.select':'选择版本',
  'installer.step1.selectUseRepoOptions.local':'使用本地资源库选项',
  ...
  'installer.step1.useLocalRepo.getSurpottedOs.stackError.title': '组件栈{0} {1}错误 ',
  'installer.step1.useLocalRepo.getSurpottedOs.noStacksError.title': '无可用的组件栈可安装',
  'installer.step1.useLocalRepo.getSurpottedOs.noStacksError.body': '所有组件栈都包含错误。无法完成安装',
  'installer.step1.useLocalRepo.addRepo.button': '添加资源库',
  'installer.step1.addVersion': '添加版本',
  'installer.step1.addVersion.stackChanged.popup.body': '组件栈从{0}更改为{1}.',
  ...
  'installer.step1.useLocalRepo.infoForm.details.stackName': '组件栈名',
  ...
  'installer.step1.useLocalRepo.infoForm.alert.baseUrl': '提供您要配置的操作系统的基础URL。',
  'installer.step1.useLocalRepo.infoForm.alert.warning': '一些资源库验证失败，如果您确定网址正确无误，请更改基础网址或跳过验证',
  'installer.step1.advancedRepo.title':'资源库高级选项',
  'installer.step1.advancedRepo.message':'自定义资源库基础URL，以下载组件栈软件包。如果您的主机无法访问Internet，则必须创建所有主机都可以访问的组件栈资源库的本地镜像，并在此处使用这些基础URL。',
  'installer.step1.advancedRepo.importantMassage':'<b>重要：</b> 使用本地资源库时，您只需要提供要为组件栈安装的操作系统的基础URL。取消选中所有其他仓库。',
  'installer.step1.advancedRepo.localRepo.error.modifyUrl':'本地资源库URL必须修改',
  'installer.step1.advancedRepo.localRepo.error.noUrl':'本地资源库所需的基础URL',
  ...
  'installer.step1.advancedRepo.localRepo.label.stack':'组件栈',
  'installer.step1.advancedRepo.localRepo.placeholder': '输入基础URL或删除此操作系统',
  'installer.step1.advancedRepo.skipValidation.tooltip':'警告：这仅适用于高级用户。如果要跳过对资源库基础UR 的验证，请使用此选项。',
  'installer.step1.advancedRepo.useRedhatSatellite.tooltip':'禁用分布式存储库，改为使用RedHat Satellite/Spacewalk通道',
  'installer.step1.advancedRepo.useRedhatSatellite.disabled.tooltip':'使用公共资源库时，无法使用RedHat Satellite/Spacewalk',
  ...
  'installer.step1.advancedRepo.useRedhatSatellite.warning': "了使Ambari从正确的资源库安装软件包，" +
      "建议您为每个操作系统编辑资源库的名称，" +
      "以使其与RedHat Satellite/Spacewalk实例中的通道名称匹配。",
  'installer.step1.addOs.disabled.tooltip':'已添加所有操作系统',
  'installer.step1.attentionNeeded':'<b>注意：</b> 在继续之前，需要至少一个操作系统的资源库基础URL，请确保其协议格式正确。',
  'installer.step1.invalidURLAttention': '<b>注意：</b> 在继续操作之前，请确保所有资源库URL均有效。',
  'installer.step1.checkAtLeastOneAttention': '<b>注意：</b> 请检查至少一个资源库。',
  ...
  'installer.step2.hostPattern.tooltip.title':'正则表达',
  'installer.step2.hostPattern.tooltip.content':'您可以使用正则表达式来指定许多目标主机。例如，要指定host10.domain到host01.domain，可在目标主机文本区域中输入host[01-10].domain 。',
  'installer.step2.hostName.error.required':'您必须至少指定一个主机名',
  'installer.step2.hostName.error.already_installed':'所有这些主机已经是集群的一部分',
  'installer.step2.hostName.error.notRequired':'如果不使用SSH自动配置主机，主机名将被忽略',
  'installer.step2.hostName.error.invalid':'无效的主机名(多)',
  'installer.step2.hostName.pattern.header':'主机名正则表达式',
  ...
  'installer.step2.manualInstall.info':'通过不使用SSH连接到目标主机，' +
      '必须手动在每个主机上安装并启动Ambari Agent，' +
      '以便向导执行必要的配置和软件安装。',
  'installer.step2.advancedOption':'高级选项',
  'installer.step2.repoConf':'软件存储仓库配置文件的路径',
  ...
  'installer.step2.localRepo.error.required':'需要本地资源库文件路径',
  'installer.step2.localRepo.tooltip.title':'本地软件资源库',
  'installer.step2.localRepo.tooltip.content': '集群安装需要访问Internet才能从远程资源库中获取软件。' +
      '在某些情况下，没有足够的带宽，并且您想防止一遍又一遍地从远程资源库下载软件包。 ' +
      '有时群集中的主机无法访问Internet，' +
      '在这种情况下，您必须设置计算机可以在本地访问的资源库版本， ' +
      '这称为<b>本地软件资源库</b>',
  'installer.step2.javaHome.label' : '64位JDK路径',
  'installer.step2.javaHome.tooltip.title' : 'JAVA_HOME',
  'installer.step2.javaHome.tooltip.content' : '64位的JAVA_HOME路径，/usr/jdk/jdk1.6.0_31是Ambari默认使用的路径。您可以将其覆盖为包含指定JD 的路径。<br/>注意：该路径必须在集群中<b>所有</b> 的主机上有效。',
  'installer.step2.javaHome.tooltip.placeholder' : '/usr/jdk/jdk1.6.0_31',
  'installer.step2.automaticInstall.tooltip.title':'自动注册',
  'installer.step2.automaticInstall.tooltip.content':'在群集安装之前，Ambari将在每台主机上自动安装并注册Ambari Agent。',
  ...
  'installer.step2.useSsh.tooltip.content':'<b>SSH私钥文件</b>用于连接集群中的目标主机以安装Ambari Agent。',
  'installer.step2.install.perform':'执行',
  'installer.step2.install.perform_on_hosts':'在主机上',
  'installer.step2.install.without_ssh':' 且不要使用SSH',
  'installer.step2.manualInstall.tooltip.title':'手动注册',
  'installer.step2.manualInstall.tooltip.content':'在每个主机上手动注册Ambari Agent，这消除了对SSH的需要，应在继续安装集群之前执行。',
  'installer.step2.manualInstall.tooltip.content_no_ssh':'在继续安装集群之前，应在每个主机上手动注册Ambari Agent。',
  ...
  'installer.step2.warning.popup.body':'<p>以下主机名不是有效的FQDN：</p><p> {0} </p><p>这可能会在安装过程中引起问题, 你要继续吗？</p>',
  'installer.step2.orUse':'或用',
  'installer.step2.registerAndConfirm':'注册并确认',
  'installer.step2.evaluateStep.installedHosts':'这些主机已经安装在群集上，将被忽略：',
  'installer.step2.evaluateStep.continueConfirm':'您是否要继续吗？',
  'installer.step2.evaluateStep.hostRegInProgress':'主机注册当前正在进行中，请稍后再试。',
  'installer.step2.sshUser':'SSH用户账号',
  'installer.step2.sshUser.toolTip':'用于通过SSH在目标主机上安装Ambari Agent的用户帐户，必须在所有目标主机上使用无密码SSH和sudo访问权限来设置此用户',
  ...
  'installer.step2.sshPort.required':'SSH端口号是必填项。',
  'installer.step2.agentUser':'Ambari Agent用户账号',
  'installer.step2.agentUser.toolTip':'用于在目标主机上运行Ambari Agent守护程序的用户帐户，必须在所有目标主机上将该用户设置为具有无密码sudo访问权限',
  'installer.step2.bootStrap.error':'在主机上设置Ambari Agent时遇到错误。',
  'installer.step2.bootStrap.inProgress':'请稍候，正在主机上设置Ambari Agent，这可能需要几分钟的时间，具体取决于主机的数量。',
  'installer.step2.bootStrap.header':'设置Ambari Agents',
  'installer.step2.skipHostChecks.label': '跳过主机检查',
  'installer.step2.skipHostChecks.popup.header': '警告',
  'installer.step2.skipHostChecks.popup.body': '通过跳过主机检查，Ambari将不会检查并警告主机是否存在任何问题，并且主机将按原样添加到群集中。',

  'installer.step3.header':'确认主机',
  'installer.step3.body':'注册主机。<br>' +
      '请确认主机列表，然后删除所有不想包含在群集中的主机。',
  'installer.step3.hostLog.popup.header':'{0}的注册日志',
  'installer.step3.hosts.remove.popup.header':'移除主机',
  'installer.step3.hosts.remove.popup.body':'您确定要删除所选主机(多)吗？',
  'installer.step3.hostInformation.popup.header':'检索主机信息时出错',
  'installer.step3.hostInformation.popup.body' : '所有启动引导主机已注册，但无法检索与CPU和内存相关的信息',
  'installer.step3.hostOsTypeCheck.popup.body' : '主机成功注册，但是主机操作系统类型与<b>选择组件栈</b>步骤：高级资源库选项，中所选的组不匹配。您可以返回到"选择组件栈"步骤或删除此主机。' +
      '主机类型为{0}，但是在步骤1中选择了组{1}。',
  'installer.step3.hostWarningsPopup.report':'显示报告',
  'installer.step3.hostWarningsPopup.report.header': '<p style="font-family: monospace">######################################<br># 主机检查报告<br>#<br># 已生成：',
  'installer.step3.hostWarningsPopup.report.hosts': '<br>######################################<br><br>######################################<br># 主机(多)<br>#<br># 用空格分隔的问题的主机列表。<br># 提供了以便管理员可以很容易地复制主机名到脚本，电子邮件等。<br>######################################<br>主机<br>',
  'installer.step3.hostWarningsPopup.report.jdk': '<br><br>######################################<br># JDK检查 <br>#<br># 用换行符分隔的JDK问题列表。<br>######################################<br>JDK问题<br>',
  'installer.step3.hostWarningsPopup.report.disk': '<br><br>######################################<br># 磁盘 <br>#<br># 用换行符分隔的磁盘问题列表。<br>######################################<br>磁盘问题<br>',
  'installer.step3.hostWarningsPopup.report.repositories': '<br><br>######################################<br># 资源库 <br>#<br># 以换行符分隔的存储库问题列表。<br>######################################<br>资源库问题<br>',
  'installer.step3.hostWarningsPopup.report.hostNameResolution': '<br><br>######################################<br># 主机名解析<br>#<br># 用换行符分隔的主机名解析问题列表。<br>######################################<br>主机名解析问题<br>',
  'installer.step3.hostWarningsPopup.report.thp': '<br><br>######################################<br># 透明大内存页面(THP) <br>#<br># 以空格分隔的主机名列表，在这些主机名上启用了“透明大页面”。<br>######################################<br>THP问题主机<br>',
  'installer.step3.hostWarningsPopup.report.firewall': '<br><br>######################################<br># 防火墙<br>#<br># 用换行符分隔的防火墙问题列表。<br>######################################<br>防火墙<br>',
  'installer.step3.hostWarningsPopup.report.fileFolders': '<br><br>######################################<br># 文件和文件夹<br>#<br># 以空格分隔的文件和文件夹列表，他们不应存在。<br># 提供了以便管理员可以很容易地复制路径到脚本，电子邮件等。<br># 例如：rm -r /etc/hadoop /etc/hbase<br>######################################<br>文件和文件夹<br>',
  'installer.step3.hostWarningsPopup.report.reverseLookup': '<br><br>######################################<br># 反向查找<br># <br># 在反向DNS查找中找不到主机名。这可能会导致错误的行为。<br># 请检查DNS设置并解决问题。<br>######################################<br>反向查找<br>',
  'installer.step3.hostWarningsPopup.report.process': '<br><br>######################################<br># 进程<br>#<br># 用逗号分隔的不应运行的进程元组列表。<br># 提供了以便管理员可以很容易地复制路径到脚本，电子邮件等。<br>######################################<br>进程<br>',
  'installer.step3.hostWarningsPopup.report.package': '<br><br>######################################<br># 包<br>#<br># 以空格分隔的应卸载软件包列表。<br># 提供了以便管理员可以很容易地复制路径到脚本，电子邮件等。<br># 例如：yum remove hadoop-hdfs yarn<br>######################################<br>包<br>',
  'installer.step3.hostWarningsPopup.report.service': '<br><br>######################################<br># 服务<br>#<br># 以空格分隔的应启动并正在运行的服务的列表。<br># 提供了以便管理员可以很容易地复制路径到脚本，电子邮件等。<br># 例如：services start ntpd httpd<br>######################################<br>服务<br>',
  'installer.step3.hostWarningsPopup.report.user': '<br><br>######################################<br># 用户<br>#<br># 用空格分隔的不应该存在的用户列表。<br># 提供了以便管理员可以很容易地复制路径到脚本，电子邮件等。<br># 例如：userdel hdfs<br>######################################<br>用户<br>',
  'installer.step3.hostWarningsPopup.report.folder': '\\ /folder',
  'installer.step3.hostWarningsPopup.checks': '找到主机检查',
  'installer.step3.hostWarningsPopup.notice.beginning': '手动解决问题后，单击<b>重新运行检查</b>。',
  'installer.step3.hostWarningsPopup.summary':'{0}上的{1}',
  'installer.step3.hostWarningsPopup.jdk':'JDK问题',
  'installer.step3.hostWarningsPopup.jdk.name':'在<i>{0}</i>上找不到JDK',
  'installer.step3.hostWarningsPopup.jdk.context':'{0}',
  'installer.step3.hostWarningsPopup.jdk.message':'以下注册的主机具有与JDK相关的问题',
  'installer.step3.hostWarningsPopup.repositories':'资源库问题',
  'installer.step3.hostWarningsPopup.repositories.name':'操作系统存储库不可用',
  'installer.step3.hostWarningsPopup.repositories.context':'主机({0})的操作系统类型为{1}，但是在“选择组件栈”步骤中选择的资源库为{2}。 选定的资源库不支持此主机操作系统类型。',
  'installer.step3.hostWarningsPopup.repositories.message': '下列注册的主机与“选择组件栈”步骤中选择的可用资源库具有不同的操作系统类型。您可以返回“选择组件栈”步骤，选择另一个操作系统资源库<b>或</b>删除主机。',
  ...
  'installer.step3.hostWarningsPopup.disk.context2':'对于"{1}"安装，至少需要{0}。',
  'installer.step3.hostWarningsPopup.disk.message':'以下已注册的主机存在与磁盘空间有关的问题',
  ...
  'installer.step3.hostWarningsPopup.firewall.message':'防火墙在以下主机上运行。请配置防火墙以允许在<a target=\"_blank\" href=\"http://ambari.apache.org/current/installing-hadoop-using-ambari/content/\">Ambari文档</a>的<i>配置端口</i>部分中记录的端口上进行通信',
  ...
  'installer.step3.hostWarningsPopup.package':'包的问题',
  'installer.step3.hostWarningsPopup.packages.message':'以下软件包应被卸载',
  ...
  'installer.step3.hostWarningsPopup.services.message':'以下服务应启动',
  'installer.step3.hostWarningsPopup.misc':'问题杂项',
  'installer.step3.hostWarningsPopup.misc.message':'以下umask应该更改',
  'installer.step3.hostWarningsPopup.misc.umask':'Umask',
  'installer.step3.hostWarningsPopup.alternatives':'选择的问题',
  'installer.step3.hostWarningsPopup.alternatives.umask' : '备选方案',
  'installer.step3.hostWarningsPopup.alternatives.message':'应该删除以下备选方案',
  'installer.step3.hostWarningsPopup.alternatives.noIssues':'没有其它问题，应删除其它备选方法',
  'installer.step3.hostWarningsPopup.alternatives.empty': '备选问题',
  'installer.step3.hostWarningsPopup.issue':'问题',
  'installer.step3.hostWarningsPopup.issues':'问题(s)',
  ...
  'installer.step3.hostWarningsPopup.empty.packages':'不必要的包',
  'installer.step3.hostWarningsPopup.empty.users':'不必要的用户',
  'installer.step3.hostWarningsPopup.empty.services':'不必要的服务',
  'installer.step3.hostWarningsPopup.empty.misc':'问题(s)',
  'installer.step3.hostWarningsPopup.empty.firewall':'防火墙运行中',
  'installer.step3.hostWarningsPopup.empty.repositories':'资源库操作系统类型与已注册主机不匹配',
  'installer.step3.hostWarningsPopup.empty.disk':'磁盘空间的问题',
  'installer.step3.hostWarningsPopup.empty.jdk':'JDK问题',
  'installer.step3.hostWarningsPopup.empty.thp':'THP问题',
  'installer.step3.hostWarningsPopup.reverseLookup.name': '反向查询验证失败于',
  ...
  'installer.step3.hostWarningsPopup.resolution.validation.message': '并非所有主机都可以解析其它主机的主机名。在继续操作之前，请确保主机解析在所有主机上均正常运行。',
  ...
  'installer.step3.hostWarningsPopup.action.notRunning':'不在运行中',
  'installer.step3.hostWarningsPopup.action.installed':'在安装',
  'installer.step3.hostWarningsPopup.action.running':'在运行',
  ...
  'installer.step3.hostWarningsPopup.hosts':'主机(s)',
  'installer.step3.hostWarningsPopup.moreHosts':'{0}更多主机...<br>单击链接以查看所有主机。',
  'installer.step3.hostWarningsPopup.allHosts':'主机列表',
  'installer.step3.hostWarningsPopup.rerunChecks':'重新检查',
  'installer.step3.hostWarningsPopup.hostHasWarnings':'您的某些主机上的主机检查失败。强烈建议您先解决这些问题，然后再继续进行操作，以防止群集安装过程中可能出现的重大问题。您确定要忽略这些警告并继续吗？',
  ...
  'installer.step3.hosts.noHosts':'没有主机可显示',
  'installer.step3.warnings.popup.header':'主机检查',
  'installer.step3.warnings.description':'对上述主机执行检查时遇到了一些警告。',
  'installer.step3.warnings.linkText':'单击此处查看警告。',
  'installer.step3.noWarnings.linkText':'单击此处查看检查结果。',
  'installer.step3.warnings.noWarnings':'所有主机检查均在{0}个已注册主机上通过。',
  'installer.step3.warnings.fails':'对上面的{0}个已注册主机执行检查时遇到了一些警告',
  'installer.step3.warnings.someWarnings':'所有主机检查均在{0}个已注册主机上通过。注意：在未注册的{1}个主机上跳过了主机检查。',
  'installer.step3.warnings.allFailed':'在{0}个注册失败的主机上跳过了主机检查。',
  ...
  'installer.step3.warning.registeredHosts': '{0}其它注册主机',
  'installer.step3.warning.loading':'正在检查主机是否存在潜在问题，请稍候...',
  'installer.step3.registeredHostsPopup': '这些是已在服务器上注册的主机，但未出现在要添加的主机列表中。',
  'installer.step3.removeSelected':'移除选择的',
  'installer.step3.retryFailed':'重试失败的',
  ...
  'installer.step3.hostLogPopup.copy':'请按CTRL+C',
  'installer.step3.hostsTable.selectAll':'选择所有主机',
  'installer.step3.selectedHosts.popup.header':'选择的主机',
  ...
  'installer.step4.fsCheck.popup.body':'您没有选择文件系统，但需要一个，我们将自动添加{0}，这个可以吗？',
  'installer.step4.multipleDFS.popup.header':'选择了多个文件系统',
  'installer.step4.multipleDFS.popup.body':'您选择了多个文件系统，我们将仅自动选择{0}，这个可以吗？',
  'installer.step4.serviceCheck.popup.header':'需要{0}',
  'installer.step4.serviceCheck.popup.body':'您没有选择{0}，但是您选择的其他服务需要它。我们将自动添加{1}，这个可以吗？',
  'installer.step4.serviceCheck.popup.body.multiOptions':'您没有选择{0}，但是您选择的其它服务需要它。从以下列表中选择兼容的服务：{1}',
  'installer.step4.hcfs.displayName':'Hadoop兼容文件系统',
  'installer.step4.limitedFunctionality.popup.header':'功能受限警告',
  'installer.step4.ambariMetricsCheck.popup.header': 'Ambari Metrics',
  'installer.step4.ambariMetricsCheck.popup.body':'Ambari Metrics从群集中收集指标并将其提供给Ambari，如果您未安装Ambari Metrics服务，则无法从Ambari访问指标。您确定要继续使用Ambari Metrics吗？',
  'installer.step4.ambariRangerInfraCheck.popup.header': 'Infra Solr',
  'installer.step4.ambariRangerInfraCheck.popup.body':'为了让Ranger工作，Solr是必需的。选择要添加到群集的Infra Solr，或者确保在<b>自定义服务</b>步骤中配置自己的Infra Solr。',
  'installer.step4.ambariAtlasInfraCheck.popup.header': 'Infra Solr',
  'installer.step4.ambariAtlasInfraCheck.popup.body':'为了使Atlas正常工作，需要Solr。选择要添加到群集的Infra Solr，或者确保在<b>自定义服务</b>步骤中配置自己的Infra Solr。',
  'installer.step4.ambariAtlasHbaseCheck.popup.header': 'HBase',
  'installer.step4.ambariAtlasHbaseCheck.popup.body':'为了使Atlas正常运行，需要 HBase。选择要添加到群集的HBase，或确保在<b>自定义服务</b>步骤中配置自己的HBase。',
  'installer.step4.ambariLogsearchCheck.popup.header': 'Ambari Logsearch',
  'installer.step4.ambariLogsearchCheck.popup.body':'由于未选择Ambari Infra，因此必须提供自己的Solr才能使Log Search工作，您确定要继续吗？',
  'installer.step4.smartSenseCheck.popup.header': 'Apache SmartSense',
  'installer.step4.smartSenseCheck.popup.body':'安全地收集群集诊断信息，以便向您发送建议并自动分析故障排除支持案例。' +
      '如果选择不安装SmartSense则不会收到任何建议， ' +
      '并且您将需要手动收集配置和日志以对支持案例进行故障排除。' +
      '您确定要在没有SmartSense的情况下继续吗？',
  'installer.step4.rangerCheck.popup.header': 'Apache Ranger',
  'installer.step4.rangerCheck.popup.body':'Apache Ranger为许多Hadoop生态系统服务的访问尝试提供了细粒度的授权和审计。如果不安装Apache Ranger服务并启用Kerberos，集群的安全性将会降低。你确定要在没有它的情况下继续吗？',
  'installer.step4.atlasCheck.popup.header': 'Apache Atlas',
  'installer.step4.atlasCheck.popup.body':'Apache Atlas为许多hadoop生态系统服务提供强大的数据治理、血缘和元数据管理。如果不安装Apache Atlas服务，集群的数据治理能力将会降低。你确定要在没有它的情况下继续吗？',

  'installer.step4.rangerRequirements.popup.header': 'Ranger要求',
  'installer.step4.rangerRequirements.popup.body.requirements': '<ol><li>您必须运行一个<strong>MySQL/Oracle/Postgres/MSSQL/SQL Anywhere服务</strong>数据库实例以供Ranger使用。</li>' +
      '<li>在该向导的“分配主服务”步骤中，将提示您为Ranger Admin指定哪台主机。在那主机上，您<strong>必须安装数据库客户端</strong>以使Ranger能够访问数据库。(注意：这仅适用于Ranger 0.4.0)</li>' +
      '<li>确保数据库服务器中任意一台主机上都开启了DB Admin用户的访问权限。</li>' +
      '<li>在Ambari服务主机上执行以下命令。根据相应的JDBC驱动程序的位置，将<code>database-type</code>替换为<strong>mysql|oracle|postgres|mssql|sqlanywhere</strong>和<code>/jdbc/driver/path</code>：' +
      '<pre>ambari-server setup --jdbc-db={database-type} --jdbc-driver={/jdbc/driver/path}</pre></li></ol>',
  'installer.step4.rangerRequirements.popup.body.confirmation': '我已经满足了以上所有要求。',
  'installer.step4.sparkWarning.popup.body': 'Spark需要HDP 2.2.2或更高版本，尝试将Spark安装到HDP 2.2.0群集将失败。确认您使用的是HDP 2.2.2或更高版本的软件包。您确定要继续吗？',

  'installer.step5.header':'分配主服务',
  'installer.step5.reassign.header':'选择目标主机',
  'installer.step5.attention':' 主机未运行Master服务',
  'installer.step5.body':'将master组件分配给要在其上运行它们的主机上。',
  ...
  'installer.step5.validationIssuesAttention': 'Master组件分配存在需要注意的问题。',
  'installer.step5.error.host.invalid': '您选择的主机可能 (1)主机名无效; (2) 与另一个选择冲突；或 (3)处于维护模式',

  'installer.step6.header':'分配从服务和客户端',
  'installer.step6.body':'分配从服务和客户端组件给要在其上运行的主机，<br/>分配了主组件的主机将显示为<i class="glyphicon glyphicon-asterisks">&#10037;</i>.',
  'installer.step6.body.clientText': ' <br/>&quot;客户端&quot; 将安装 ',
  'installer.step6.error.mustSelectOne':'您必须为每个组件至少分配一台主机。',
  'installer.step6.error.mustSelectOneForHost':'您必须为每个组件至少分配一个从服务或客户端组件。',
  ...
  'installer.step6.error.mustSelectOneForSlaveHost': '您必须为没有主组件的每个主机至少分配一个从服务或客户端组件',
  ...
  'installer.step6.validationIssuesAttention': '从服务和客户端组件分配存在需要注意的问题。',

  'installer.step7.header':'自定义服务',
  'installer.step7.body':'我们为您选择的服务提供了推荐的配置，根据需要自定义它们。',
  'installer.step7.credentialsTab.body':'请提供这些服务的凭证',
  'installer.step7.databasesTab.body':'请为这些服务选择并配置合适的数据库',
  ...
  'installer.step7.attentionNeeded':'<b>注意：</b> 在进行某些配置之前，需要引起您的注意。',
  ...
  'installer.step7.ConfigErrMsg.message':'自定义配置中的错误，在框中输入的某些属性已在此页面上显示',
  ...
  'installer.step7.popup.rddWarning.body':'建议为Ganglia服务日志至少提供16GB的空间，但是{1}上的磁盘安装"{0}"没有足够的空间（{2}可用）。转到“杂项”选项卡然后更改具有超过16GB磁盘空间的Ganglia rrdcached基础目录。如果继续进行而不进行更改，则{1}可能会用完磁盘空间而无法使用。',
  'installer.step7.popup.mySQLWarning.header':'错误：新的MySQL数据库用于Hive有冲突',
  'installer.step7.popup.mySQLWarning.body':'您不能在与Ambari Server MySQL Server相同的主机上为Hive安装\"新的MySQL数据库\"。请返回<b>分配主服务</b>并将Hive重新分配给另一台主机<b>或</b>选择\"现有MySQL数据库\"选项以指定Ambari Server MySQL Server实例的数据库凭据和URL。如果选择\"现有MySQL数据库\"选项则需要执行Hive必备步骤来为Hive准备MySQL Server实例。',
  'installer.step7.popup.mySQLWarning.button.gotostep5': '跳转到分配主服务',
  'installer.step7.popup.mySQLWarning.button.dismiss': '不理会',
  'installer.step7.popup.mySQLWarning.confirmation.header': '确认：跳转到分配主服务',
  'installer.step7.popup.mySQLWarning.confirmation.body': '您将回到\"分配主服务\"步骤，并且将丢失所有当前的自定义设置。您确定吗？',
  'installer.step7.popup.database.connection.header': '数据库连接警告',
  'installer.step7.popup.database.connection.body': '您尚未运行或通过{0}的数据库连接测试，强烈建议您在继续进行操作之前通过连接测试，以防止部署期间失败。',
  'installer.step7.popup.validation.failed.header': '一致性检查失败',
  'installer.step7.popup.validation.failed.body': '某些服务配置不正确。您必须根据建议的值更改突出显示的配置。',
  'installer.step7.popup.validation.request.failed.body': '由于未知错误无法验证配置更改的一致性，您的更改尚未保存。您要继续并保存更改吗？',
  ...
  'installer.step7.popup.validation.criticalIssues.body': '您必须先更正以下关键问题，然后再继续：',
  'installer.step7.popup.oozie.derby.warning': '不建议将Derby用于生产，使用Derby将无法使用Oozie Server HA和并发连接支持。',
  ...
  'installer.step7.addWizard.notEditable': '无法在<b>添加服务</b>向导中编辑此配置',
  ...
  'installer.step7.assign.master.dependent.component.body':'如果不存在{0}，那么还将在所选主机上安装{0}。',
  'installer.step7.missing.service.header':'服务缺失',
  'installer.step7.missing.service.body': '应将{0}服务添加到集群中的{1}。',
  'assign.master.popup.header':'选择{0}主机',
  'assign.master.popup.cancel.body':'不选择{0}主机将禁用交互式查询。',
  'installer.step7.recommendations.popover.header': '审核建议',
  'installer.step7.recommendations.popover.message': '<p>据您的配置更改，Ambari建议进行以下相关的配置更改。Ambari已将所有选中的配置更改更新为<strong>推荐值</strong>。取消选中任何配置以保留<strong>原始值</strong>。</p>',
  'installer.step7.requirements.popover.header': '所需的配置',
  'installer.step7.requirements.popover.message': '<p>必须设置以下属性才能继续安装。</p>',

  'installer.step8.header': '回顾',
  'installer.step8.body': '安装前请检查配置',
  'installer.step8.kerberors.warning': '<strong>因为已经在集群上手动安装了Kerberos，所以在完成此操作后，您必须创建/分发principal和keytab。</strong>',
  'installer.step8.generateBlueprint.popup.msg': '您将<b>下载</b> blueprint.json和clustertemplate.json到本地计算机。<br/><br/>您可以使用它们通过AMBARI REST API部署集群。<br/>如果不想使用名称<b>{0}</b>，请使用自定义群集名称更新clustertemplate.json。<br/><br/>如果要使用自定义资源库URL，请确保在部署群集之前通过Ambari REST API更新它们。',
  'installer.step8.deployPopup.message':'准备部署：已完成{1}个任务中的{0}个。',
  'installer.step8.deployPopup.header':'初始化任务',
  'installer.step8.hosts':' 主机(多)',
  ...
  'installer.step9.body':'在安装并启动所选服务时，请等待。',
  'installer.step9.status.success':'成功安装并启动了服务。',
  'installer.step9.status.skipStartSuccess':'已成功安装服务。',
  'installer.step9.status.warning':'安装并启动带有一些警告的服务。',
  'installer.step9.status.failed':'无法安装/启动服务。',
  'installer.step9.status.start.services.failed':'启动所有服务的API调用失败。',
  'installer.step9.status.install.components.failed': '某些服务组件仍然无法成功安装，请重试',
  'installer.step9.status.hosts.heartbeat_lost': 'Ambari agent在{0}主机上未运行。',
  'installer.step9.host.heartbeat_lost': '主机失去心跳',
  'installer.step9.host.heartbeat_lost_popup': 'Ambari agent进程在主机上无心跳',
  ...
  'installer.step9.hosts.filteredHostsInfo': '{0}/{1}主机在显示',
  'installer.step9.hostLog.popup.header':'任务，在执行中 ',
  'installer.step9.hostLog.popup.categories.all':'全部',
  'installer.step9.hostLog.popup.categories.pending':'队列/待处理',
  ...
  'installer.step9.hostLog.popup.categories.aborted':'已中止',
  'installer.step9.hostLog.popup.categories.timedout':'超时',
  'installer.step9.hostLog.popup.noTasksToShow':'无任务可显示',
  'installer.step9.host.status.noTasks': 'Ambari server未在主机上安排任何任务，主机上的服务组件已经处于安装状态<b>或</b>主机可达性的预检查失败。',
  ...
  'installer.step9.serviceStatus.abort.failed':' 失败中止',
  'installer.step9.components.install.failed': '安装失败',
  'installer.step9.service.start.failed': '启动已安装的服务时出现问题。请转到各个服务页面来启动它们。',
  'installer.step9.service.start.header': '启动服务',

  'installer.step10.header':'摘要',
  'installer.step10.body':'这是安装过程的摘要。',
  'installer.step10.staleServicesRestartRequired':' 关闭此向导后，请重新启动所有在服务名称旁边带有' +
      '重启提示符<i class="glyphicon glyphicon-refresh"></i> 的服务。',
  'installer.step10.hostsSummary':'群集由{0}个主机组成',
  'installer.step10.installedAndStarted':'在新安装的{0}上成功安装并启动了服务 ',
  'installer.step10.installed':'已成功在新安装的{0}上安装了服务 ',
  ...
  'installer.step10.master.installedOn':'{0}已安装在{1}',
  ...
  'installer.step10.installTime.seconds':'安装并在{0}秒内完成启动',
  'installer.step10.installTime.minutes':'安装并在{0}分钟{1}秒内开始完成',
  ...
  'form.validator.configKey':'无效的key，仅允许使用字母数字、连字符、下划线、星号和句点。',
  'form.validator.configGroupName':'无效的组名，仅允许使用字母数字、连字符、空格和下划线。',
  'form.validator.alertGroupName':'无效的警报组名称，仅允许使用字母数字、连字符、空格和下划线。',
  'form.validator.alertNotificationName':'无效的警报通知名称，仅允许使用字母数字、连字符、空格和下划线。',
  'form.validator.configKey.specific':'"{0}"是无效的key，仅允许使用字母数字、连字符、下划线、星号和句点。',

  'alerts.dropdown.dialog.title': '通知事项',
  'alerts.dropdown.dialog.filters.critical': '关键的({0})',
  ...
  'alerts.add.step1.header.description': '选择您要创建的告警类型',
  ...
  'alerts.add.wizard.step1.body.web.description':'检查TCP连接并验证是否返回了正确的HTTP响应码',
  'alerts.add.wizard.step1.body.metric.description':'定义可以查询值的JMX/AMS端点',
  'alerts.add.wizard.step1.body.script.description':'将所有功能延迟到Ambari agents可以从指定的相对或绝对路径访问的Python脚本',
  'alerts.add.wizard.step1.body.aggregate.description':'合并来自不同节点的另一个告警定义的结果',
  ...
  'alerts.fastAccess.popup.body.showmore': '跳转到告警定义',
  'alerts.fastAccess.popup.body.noalerts': '没有严重或警告告警显示',
  ...
  'alerts.actions.editRepeatTolerance.description': '设置在发送通知之前要执行的告警检查的次数。' +
      '如果在警报检查期间发生状态更改，Ambari将尝试在发送通知之前检查此次数。' +
      '如果您的环境遇到瞬态问题而导致错误告警，请增加此数字。',
  ...
  'alerts.table.header.helpUrl': '告警环境',
  'alerts.table.state': '状态',
  'alerts.table.state.enabled': '启用',
  'alerts.table.state.disabled': '禁止',
  'alerts.table.state.enabled.tooltip': '单击以禁用此告警定义',
  'alerts.table.state.disabled.tooltip': '单击以启用此告警定义',
  'alerts.table.state.enabled.confirm.msg': '您将要禁用此告警定义。',
  'alerts.table.state.disabled.confirm.msg': '您将要启用此告警定义。',
  ...
  'alert.definition.name.invalid': '输入无效。仅允许使用字母数字、下划线、连字符、百分比、方括号和空格，值应小于 255 个符号。',
  ...
  'alerts.definition.details.noAlerts': '没有要显示的告警实例',
  ...
  'alerts.notifications.error.SMTPUsername': '用户名为必填项',
  'alerts.notifications.error.SMTPPassword': '密码为必填项',
  'alerts.notifications.error.retypePassword': '确认的密码必须与密码匹配',

  'alerts.notifications.addCustomPropertyPopup.header': '添加属性',
  'alerts.notifications.addCustomPropertyPopup.error.propertyExists': '当前自定义属性名已存在',
  'alerts.notifications.addCustomPropertyPopup.error.invalidPropertyName': '属性名称只能包含字母、数字或 .-_* 字符',
  'alerts.notifications.regenerateKeytab.service.error' : '{0}服务的Keytabs无法重新生成',
  'alerts.notifications.regenerateKeytab.host.error' : '{0}主机的Keytabs无法重新生成',
  ...
  'admin.advanced.caution':'本部分仅适用于高级用户，请<br/>谨慎操作。',
  'admin.advanced.button.uninstallIncludingData':'卸载群集，包括所有数据。',
  'admin.advanced.button.uninstallKeepData':'卸载群集，但保留数据。',
  ...
  'admin.audit.grid.performedBy':"执行的",
  ...
  'admin.authentication.form.primaryServer':'主服务',
  'admin.authentication.form.secondaryServer':'辅助服务',
  ...
  'admin.kerberos.credentials.store.hint.supported': '当选中后，Ambari将存储KDC Admin凭据，因此在将来更改服务、主机和组件时不需要重新输入它们。',
  'admin.kerberos.credentials.store.hint.not.supported': '没有将Ambari配置为用于存储凭据',
  'admin.kerberos.credentials.store.label': '保存Admin凭证',
  'admin.kerberos.credentials.store.menu.label': '管理KDC凭证',
  'admin.kerberos.credentials.form.header.stored': '更新或移除加密凭据存储中存储的KDC凭据。',
  'admin.kerberos.credentials.form.header.not.stored': '指定要记住的KDC Admin凭据，以存储在加密的凭据存储中。',
  'admin.kerberos.credentials.remove.confirmation.header': '移除KDC凭证确认',
  'admin.kerberos.credentials.remove.confirmation.body': '您将要从Ambari中删除KDC凭据，您确定吗？',
  'admin.kerberos.wizard.configuration.note': '这是由“启用Kerberos”向导创建的初始配置。',
  ...
  'admin.kerberos.wizard.exit.warning.msg': '正在配置Kerberos，您是否真的要退出“启用Kerberos向导”？',
  'admin.kerberos.wizard.exit.critical.msg': '正在配置Kerberos。<strong>关闭之前，您应该先完成向导。</strong>您是否真的要退出“启用Kerberos向导”？',
  ...
  'admin.kerberos.wizard.step1.info.body': '欢迎使用Ambari安全向导。使用此向导可以在集群中启用Kerberos安全性。</br>开始吧。',
  'admin.kerberos.wizard.step1.alert.body': '注意：此过程需要重新启动服务并使群集停机，此外根据您选择的选项，可能需要安全管理员的支持。请据此计划。',
  'admin.kerberos.wizard.step1.body.text': '您打算使用哪种类型的KDC？',
  'admin.kerberos.wizard.step1.option.kdc': '现有的MIT KDC',
  'admin.kerberos.wizard.step1.option.kdc.condition.1': 'Ambari服务和群集主机可以同时访问KDC和KDC admin主机。',
  'admin.kerberos.wizard.step1.option.kdc.condition.2': 'KDC管理凭据已准备就绪。.',
  'admin.kerberos.wizard.step1.option.kdc.condition.3': '已在Ambari服务主机和群集中的所有主机上设置了Java Cryptography Extensions（JCE）。',
  'admin.kerberos.wizard.step1.option.kdc.condition.4': 'Isilon管理员已在OneFS中设置了所有合适的principals',
  'admin.kerberos.wizard.step1.option.manual': '手动管理Kerberos principals和keytabs manually',
  'admin.kerberos.wizard.step1.option.manual.condition.1': '群集主机可以通过网络访问KDC',
  'admin.kerberos.wizard.step1.option.manual.condition.2': 'Kerberos客户端实用工具（例如kinit）已安装在每个群集主机上',
  'admin.kerberos.wizard.step1.option.manual.condition.3': '已在Ambari服务主机和群集中的所有主机上设置了Java Cryptography Extensions（JCE）',
  'admin.kerberos.wizard.step1.option.manual.condition.4': '在完成此向导之前，将在KDC中手动创建服务Principals和Ambari Principals',
  'admin.kerberos.wizard.step1.option.manual.condition.5': '在完成此向导之前，将手动创建服务和Ambari Principals的keytabs并将其分发到群集主机',
  'admin.kerberos.wizard.step1.option.ad': '现有的Active Directory',
  'admin.kerberos.wizard.step1.option.ad.condition.1': 'Ambari服务和群集主机可以通过网络访问Domain控制器。',
  'admin.kerberos.wizard.step1.option.ad.condition.2': 'Active Directory安全LDAP（LDAPS）连接已配置。',
  'admin.kerberos.wizard.step1.option.ad.condition.3': 'principals的Active Directory用户容器已创建并已就绪（例如 OU=Hadoop,OU=People,dc=apache,dc=org）',
  'admin.kerberos.wizard.step1.option.ad.condition.4': '现有的Active Directory管理凭据（在前面提到的“用户”容器上具有“创建、删除和管理用户帐户”的委派控制）。',
  'admin.kerberos.wizard.step1.option.ad.condition.5': '已在Ambari服务主机和群集中的所有主机上设置了Java Cryptography Extensions（JCE）。',
  'admin.kerberos.wizard.step1.option.ipa': '现有的IPA',
  'admin.kerberos.wizard.step1.option.ipa.condition.1': '所有群集主机均已加入IPA域，并且主机已在DNS中注册',
  'admin.kerberos.wizard.step1.option.ipa.condition.2': '如果您不打算使用Ambari管理krb5.conf，请确保在集群中的每个krb5.conf文件中都设置了以下内容：default_ccache_name = /tmp/krb5cc_%{uid}',
  'admin.kerberos.wizard.step1.option.ipa.condition.3': '已经在Ambari Server主机和集群中的所有主机上设置了Java加密扩展（JCE）。',
  'admin.kerberos.wizard.step1.prerequisites.label': '需要检查以下先决条件才能在向导中继续进行。',
  ...
  'admin.kerberos.wizard.step3.notice.inProgress': '在安装和测试Kerberos客户端中，请稍等。',
  'admin.kerberos.wizard.step3.notice.completed': 'Kerberos服务已安装并成功测试。',
  'admin.kerberos.wizard.progressPage.notice.inProgress': '正在对集群进行kerberized中，请稍等',
  'admin.kerberos.wizard.step4.info.body': '为服务用户和hadoop服务组件配置principal和keytab位置。',
  'admin.kerberos.wizard.step5.info.body': '请先检查配置，然后再继续进行设置过程',
  'admin.kerberos.wizard.step5.moreInfoNonManual.body': '使用<b>“下载CSV”按钮</b>，您可以下载一个csv文件，其中包含将由Ambari自动创建的principals和keytabs的列表。',
  'admin.kerberos.wizard.step5.moreInfoManual.body': '重要提示：使用<b>下载CSV</b>按钮获取Ambari启用群集中的Kerberos要求的<b>必需</b>principals和keytabs的列表。<b>请勿继续</b>，直到您手动创建了principals和keytabs并将其分发到群集主机为止。',
  'admin.kerberos.wizard.step5.kdc_type.label': 'KDC类型',
  'admin.kerberos.wizard.step5.kdc_hosts.label': 'KDC主机',
  'admin.kerberos.wizard.step5.realm.label': 'Realm名',
  'admin.kerberos.wizard.step5.ldap_url.label': 'LDAP URL',
  ...
  'admin.kerberos.wizard.step5.group.label': '组用户principals应为成员',
  'admin.kerberos.wizard.step6.task0.title' : '停止服务',
  'admin.kerberos.wizard.step6.task1.title' : '删除ATS',
  'admin.kerberos.wizard.step6.notice.inProgress': '正在停止服务，请稍等。',
  'admin.kerberos.wizard.step6.notice.completed': '服务已成功停止。',
  'admin.kerberos.wizard.step7.notice.inProgress': '正在对集群进行kerberized中，请稍等。',
  'admin.kerberos.wizard.step7.notice.completed': 'Kerberos已成功在群集上启用。',
  'admin.kerberos.wizard.step8.notice.inProgress': '正在启动和测试服务中，请稍等。',
  'admin.kerberos.wizard.step8.notice.completed': '服务已在kerberos环境中成功测试。',
  'admin.kerberos.wizard.step8.notice.failed': '某些服务无法成功启动和执行测试。单击“重试”再次尝试，或单击“完成”以关闭向导并手动修复。',
  'admin.kerberos.wizard.step8.task0.title' : '启动并测试服务',

  'admin.kerberos.regenerate_keytabs.popup.body': '为群集中的<strong>所有</strong>主机重新生成keytabs是一项破坏性的操作，需要重新启动所有组件。（可选）可以为丢失的主机和组件<strong>仅</strong>重新生成keytabs，并且此操作需要有选择地重新启动那些受影响的主机和服务。',
  'admin.kerberos.regenerate_keytabs.checkbox.label': ' 仅重新生成缺少主机和组件的keytabs',
  'admin.kerberos.regenerate_keytabs.popup.restart.body': 'keytabs重新生成完成后，<strong>必须</strong>重新启动依赖它们的服务。这可以自动完成，也可以手动完成。',
  'admin.kerberos.regenerate_keytabs.checkbox.restart.label': 'keytabs重新生成后自动重新启动组件',
  'admin.kerberos.service.alert.yarn': 'YARN日志和本地目录将被删除，并且ResourceManager状态将被格式化为 “启用/禁用Kerberos”的一部分。',

  'admin.kerberos.disable.step1.task0.title': '启动ZooKeeper',
  'admin.kerberos.disable.step1.task1.title': '停止所需的服务',
  'admin.kerberos.disable.step1.task2.title': '无kerberize集群',
  'admin.kerberos.disable.step1.task3.title': '移除Kerberos',
  'admin.kerberos.disable.step1.task4.title': '启动服务',

  'admin.kerberos.disable.unkerberize.header': '无kerberize集群',
  'admin.kerberos.disable.unkerberize.message': '集群为无kerberize，您无法退出向导',
  'admin.kerberos.disable.inProgress': '正在对集群进行无kerberized，请稍等',
  'admin.kerberos.disable.notice.completed': '在没有kerberos环境的情况下，服务已成功测试。',
  'admin.kerberos.wizard.step1.notice.inProgress': '正在对集群进行无kerberized，请稍等',

  'admin.manageJournalNode.label': '管理JournalNodes',
  'admin.manageJournalNode.warning': '管理JournalNodes向导要求启动所有NameNode并定义“活动/备用”状态',
  ...
  'admin.manageJournalNode.wizard.step5.header': '拷贝JournalNode目录',
  'admin.manageJournalNode.wizard.step6.header': '启动JournalNodes',
  'admin.manageJournalNode.wizard.step7.header': '启动所有服务',

  'admin.manageJournalNode.wizard.step1.body': '添加, 或移除JournalNodes',
  'admin.manageJournalNode.wizard.step3.confirm.hosts.body': '<b>确认您的主机选择。</b>',
  'admin.manageJournalNode.wizard.step3.confirm.config.body': '<p><b>回顾配置更改</b></p>' +
      '作为此过程的一部分需要更改配置，请查看下面的更改并注意它们仅用于<b>查看</b>。此向导中的后续步骤将更新此配置，并自动重新启动<b>所有</b>服务。',

  'admin.manageJournalNode.wizard.step4.task0.title' : '关闭备用的NameNode',
  'admin.manageJournalNode.wizard.step4.task1.title': '关闭服务',
  ...
  'admin.manageJournalNode.wizard.step5.bodyHeader': '所需的手动步骤：复制JournalNode目录',


  'admin.manageJournalNode.step4.save.configuration.note' : '此配置由“管理JournalNode向导”创建',

  'admin.manageJournalNode.wizard.progressPage.notice.inProgress': '正在部署JournalNodes中，请稍等',
  'admin.manageJournalNode.wizard.step4.notice.inProgress': '正在部署JournalNodes中，请稍等',
  'admin.manageJournalNode.wizard.step6.notice.inProgress': 'JournalNodes启动中，请稍等',
  'admin.manageJournalNode.wizard.step7.notice.inProgress': '服务启动中，请稍等',
  'admin.manageJournalNode.wizard.step7.notice.completed':'已完成对JournalNodes的更新。',

  'admin.manageJournalNode.wizard.step3.error.multipleNameSpaces.nameNodes': '某些NameNode正在关闭中，请确保NameNodes正在运行以成功创建检查点。',
  'admin.manageJournalNode.wizard.step3.body.singleNameSpace.safeModeText': '将NameNode设置为安全模式（只读模式）',
  'admin.manageJournalNode.wizard.step3.body.multipleNameSpaces.safeModeText': '将NameNode设置为安全模式（只读模式）',
  'admin.manageJournalNode.wizard.step3.body.singleNameSpace.safeModeCommand': 'sudo su {0} -l -c \'hdfs dfsadmin -safemode enter\'',
  'admin.manageJournalNode.wizard.step3.body.multipleNameSpaces.safeModeCommand': 'sudo su {0} -l -c \'hdfs dfsadmin -fs hdfs://{1} -safemode enter\'',
  'admin.manageJournalNode.wizard.step3.body.singleNameSpace.checkPointText': '进入安全模式后，创建一个检查点',
  'admin.manageJournalNode.wizard.step3.body.multipleNameSpaces.checkPointText': '进入安全模式后，创建一个检查点',
  'admin.manageJournalNode.wizard.step3.body.singleNameSpace.checkPointCommand': 'sudo su {0} -l -c \'hdfs dfsadmin -saveNamespace\'',
  'admin.manageJournalNode.wizard.step3.body.multipleNameSpaces.checkPointCommand': 'sudo su {0} -l -c \'hdfs dfsadmin -fs hdfs://{1} -saveNamespace\'',
  'admin.manageJournalNode.wizard.step3.body.singleNameSpace.proceed': '一旦Ambari检测到NameNode处于安全模式并且成功创建了检查点，您就可以继续。',
  'admin.manageJournalNode.wizard.step3.body.multipleNameSpaces.proceed': '一旦Ambari检测到NameNode处于安全模式并且成功创建了检查点，您就可以继续。',
  'admin.manageJournalNode.wizard.step3.body.singleNameSpace.recentCheckPoint': '如果在运行<b>“第3步：保存Namespace” </b>命令之前启用了<b>下一步</b>按钮，则表明已经存在一个新的Checkpoint，并且您可以继续运行而无需执行<b>“第3步：保存Namespace” </b>命令。',
  'admin.manageJournalNode.wizard.step3.body.multipleNameSpaces.recentCheckPoint': '如果在运行<b>“第3步：保存Namespace” </b>命令之前启用了<b>下一步</b>按钮，则表明已经存在一个最近的Checkpoint，并且您可以无需执行<b>“第3步：保存Namespace” </b>命令。',
  'admin.manageJournalNode.wizard.step3.body':
      '<ol>' +
      ...
      '<div class="alert alert-warn">{6}</div>' +
      '</ol>',
  'admin.manageJournalNode.wizard.step3.checkPointsNotCreated': '尚未创建Checkpoint',
  'admin.manageJournalNode.wizard.step3.checkPointsCreated': 'Checkpoints已创建',

  'admin.manageJournalNode.wizard.step5.body':
      '<ol>' +
      '<li>登陆到JournalNode主机 <b>{0}</b>.</li>' +
      '<li>创建目录的压缩包：{1}。</li>' +
      '<li>将压缩包复制到新的JournalNodes上然后在相应位置解压缩，如步骤 2 所示。</li>' +
      '</ol>',
  ...
  'admin.highAvailability.confirmManualRollbackBody':'您正在启用NameNode HA，如果现在退出，则必须按照手册中的说明还原为非HA设置，如《Ambari用户指南》的<i>回滚NameNode HA</i>部分中所述。您确定要退出向导吗？',
  'admin.highAvailability.error.hostsNum':'群集中必须至少有3台主机才能启用NameNode HA。',
  'admin.highAvailability.error.namenodeStarted':'启用NameNode HA之前，NameNode必须正在运行。',
  'admin.highAvailability.error.maintenanceMode':'为了启用NameNode HA，所有服务和具有主组件的主机都必须退出维护模式。',
  'admin.highAvailability.error.zooKeeperNum':'群集中必须至少有3个ZooKeeper服务才能启用NameNode HA。',
  'admin.rm_highAvailability.error.hostsNum':'集群中必须至少有3个主机才能启用ResourceManager HA。',
  'admin.rm_highAvailability.error.zooKeeperNum':'集群中必须至少有3个ZooKeeper服务才能启用ResourceManager HA。',
  'admin.rm_highAvailability.error.resourceManagerStarted':'启用ResourceManager HA之前，ResourceManager必须正在运行。',
  'admin.rm_highAvailability.closePopup':'启用ResourceManager HA向导正在进行中，您必须允许向导完成才能使Ambari处于可用状态。如果选择退出，则必须按照《Ambari用户指南》中所述手动完成或还原启用ResourceManager HA的说明。您确定要退出向导吗？',

  'admin.highAvailability.wizard.header':'启用NameNode HA向导',
  'admin.highAvailability.wizard.progressPage.notice.inProgress':'正在部署NameNode HA中，请稍等。',
  'admin.highAvailability.wizard.progressPage.header':'部署',
  'admin.highAvailability.wizard.step1.header':'开始',
  'admin.highAvailability.wizard.step1.nameserviceid.tooltip.title':'Nameservice ID',
  'admin.highAvailability.wizard.step1.nameserviceid.tooltip.content':'这将是NameNode HA群集的ID，例如如果将Nameservice ID设置为<b>mycluster</b>，则HDFS的逻辑URI将为<b>hdfs://mycluster</b>。',
  'admin.highAvailability.wizard.step1.nameserviceid':'Nameservice ID',
  'admin.highAvailability.wizard.step1.nameserviceid.error':'必须包含字母、数字和连字符，不能以连字符开头或结尾。',
  ...
  'admin.highAvailability.wizard.step4.error.nameNode':'NameNode正在停止中，请确保NameNode正在运行以成功创建检查点。',
  ...
  'admin.highAvailability.wizard.step4.bodyHeader':'所需的手动步骤：在NameNode创建Checkpoint',
  'admin.highAvailability.wizard.step6.bodyHeader':'所需的手动步骤：初始化JournalNodes',
  'admin.highAvailability.wizard.step8.bodyHeader':'所需的手动步骤：初始化NameNode HA Metadata',

  'admin.rollbackHighAvailability.wizard.step1.header':'选择主机页面',
  'admin.rollbackHighAvailability.wizard.step2.header':'创建Checkpoint页面',
  'admin.rollbackHighAvailability.wizard.step3.header':'Progress页面',

  'admin.highAvailability.wizard.step5.notice.inProgress':'请等待向导配置组件。',
  'admin.highAvailability.wizard.step7.notice.inProgress':'在向导启动组件时，请稍等。',
  'admin.highAvailability.wizard.step9.notice.inProgress':'请等待向导完成HA设置。',
  'admin.highAvailability.wizard.rollback.notice.inProgres':'还原回非HA设置',
  ...
  'admin.highAvailability.wizard.rollback.header.title':'还原回非HA设置。',

  'admin.highAvailability.wizard.step5.task0.title':'停止所有服务',
  'admin.highAvailability.wizard.step5.task1.title':'安装追加的NameNode',
  ...
  'admin.highAvailability.wizard.step7.task2.title':'启动Mysql服务',
  'admin.highAvailability.wizard.step7.task3.title':'启动Ranger',
  'admin.highAvailability.wizard.step7.task4.title':'启动NameNode',

  'admin.highAvailability.wizard.step9.task0.title':'启动追加的NameNode',
  ...
  'admin.highAvailability.wizard.step3.curNameNode': '<b>当前的NameNode：</b> ',
  'admin.highAvailability.wizard.step3.addNameNode': '<b>追加的NameNode：</b> ',
  'admin.highAvailability.wizard.step3.secNameNode': '<b>Secondary NameNode:</b> ',
  'admin.highAvailability.wizard.step3.journalNode': '<b>JournalNode:</b> ',
  'admin.highAvailability.wizard.step3.toBeInstalled': '需要安装',
  'admin.highAvailability.wizard.step3.toBeDeleted': '需要删除',
  'admin.highAvailability.wizard.step4.ckNotCreated':'尚未创建Checkpoint',
  ...
  'admin.highAvailability.wizard.step8.confirmPopup.body':'在继续操作之前，请确认您已经执行了手动步骤。',
  'admin.highAvailability.wizard.step9.hawq.confirmPopup.header':'HAWQ所需的其他步骤',
  'admin.highAvailability.wizard.step9.hawq.confirmPopup.body':'您必须参考“HAWQ 文件空间和启用高可用性的HDFS”部分下的HAWQ文档，' +
      '"并执行必需的手动步骤来更新HAWQ文件空间位置。 ' +
      '除非步骤已成功完成，否则HAWQ将不会使用HDFS nameservice。',
  ...
  'admin.highAvailability.rollback.task4.title':'停止故障控制器',
  'admin.highAvailability.rollback.task5.title':'删除故障控制器',
  'admin.highAvailability.rollback.task6.title':'删除PXF',
  'admin.highAvailability.rollback.task7.title':'停止追加的NameNode',
  ...
  'admin.highAvailability.rollback.task13.title':'删除追加的NameNode',
  'admin.highAvailability.rollback.task14.title':'启动所有服务',
  'admin.highAvailability.rollback.notice.inProgress':'请等待向导恢复为非HA设置。',

  'admin.highAvailability.rollback.step2.body':
      '<ol>' +
      '<li>登录到NameNode主机<b>{1}</b>。</li>' +
      '<li>将NameNode设置为安全模式（只读模式）：' +
      '<div class="code-snippet">sudo su {0} -l -c \'hdfs dfsadmin -safemode enter\'</div></li>' +
      '<li>进入安全模式后，创建一个Checkpoint：' +
      '<div class="code-snippet">sudo su {0} -l -c \'hdfs dfsadmin -saveNamespace\'</div></li>' +
      '</ol>',
  ...
  'admin.highAvailability.wizard.step8.body':
      '<ol>' +
      '<li>登录到NameNode主机<b>{1}</b>。</li>' +
      '<li>通过执行初始化NameNode自动故障转移的元数据：' +
      '<div class="code-snippet">sudo su {0} -l -c \'hdfs zkfc -formatZK\'</div></li>' +
      '<li>登录到追加的NameNode主机<b>{2}</b>。<br>' +
      '<div class="alert alert-warning"><strong>重要！</strong>确保登录到追加的NameNode主机。<br>这与上述步骤1和2主机不同。</div>' +
      '</li>' +
      '<li>通过执行初始化追加的NameNode元数据：' +
      '<div class="code-snippet">sudo su {0} -l -c \'hdfs namenode -bootstrapStandby\'</div></li>' +
      '</ol>',
  ...
  'admin.highAvailability.wizard.step6.body':
      '<ol>' +
      '<li>登录到NameNode主机<b>{1}</b>。</li>' +
      '<li>通过执行命令来初始化JournalNodes：' +
      '<div class="code-snippet">sudo su {0} -l -c \'hdfs namenode -initializeSharedEdits\'</div></li>' +
      '<li>一旦Ambari检测到JournalNode已成功初始化，您就可以继续。</li>' +
      '</ol>',
  'admin.highAvailability.wizard.step4.body':
      '<ol>' +
      '<li>登录到NameNode主机<b>{1}</b>。</li>' +
      ...
      '<li>进入安全模式后，创建一个Checkpoint：' +
      '<div class="code-snippet">sudo su {0} -l -c \'hdfs dfsadmin -saveNamespace\'</div></li>' +
      '<li>一旦Ambari检测到NameNode处于安全模式并且成功创建了Checkpoint，您就可以继续。</li>'+
      '<div class="alert alert-warning">如果在运行<b>“第4步：创建Checkpoint” </b>命令之前启用了<b>下一步</b>按钮，则表示已经存在一个新的检查点，您可以不运行<b>“第4步：创建Checkpoint”</b>命令。</div>' +
      '</ol>',
  'admin.highAvailability.wizard.step3.confirm.host.body':'<b>确认您的主机选择。</b>',
  'admin.highAvailability.wizard.step3.confirm.config.body':'<div class="alert alert-info">' +
      '<p><b>回顾配置更改。</b></p>' +
      '以下列出了向导将启用NameNode HA的配置更改，该信息用于<b>仅审查</b>，除<b>dfs.journalnode.edits.dir</b>属性外，不可编辑。' +
      '</div>',
  'admin.highAvailability.wizard.step2.body':'选择将要运行追加的NameNode的主机。<br/>另外，' +
      '选择要运行的JournalNodes主机，这些主机以容错的方式存储NameNode edit logs。',
  'admin.highAvailability.wizard.step1.body':'该向导将引导您在群集上启用NameNode HA。' +
      '启用后除了活动NameNode之外，您还将运行备用 NameNode。' +
      '这将允许Active-Standby NameNode配置自动执行故障转移。' +
      '启用HA的过程涉及<b>自动步骤</b>（这将由向导处理）和' +
      '<b>手动步骤</b>（必须按照向导的指示依次执行）的组合。' +
      '<b>您应规划群集维护窗口，并在启用NameNode HA时为群集停机做好准备。</b>',
  'admin.highAvailability.wizard.step1.alert':'如果您正在运行HBase，请先退出该向导并停止HBase。',
  'admin.highAvailability.wizard.step1.hawq.alert':'<br/><br/>在此向导完成后，您将需要执行额外的手动' +
      '步骤来更新HAWQ文件空间位置。更多信息请参考HAWQ文档中的' +
      '“HAWQ Filespaces and High Availability Enabled HDFS”部分。',

  'admin.rm_highAvailability.wizard.header': '启用ResourceManager HA向导',
  'admin.rm_highAvailability.wizard.step1.header': '开始吧',
  'admin.rm_highAvailability.wizard.step1.body':'此向导将引导您逐步在集群上启用ResourceManager HA。<br/>' +
      '启用后除了活动ResourceManager之外，您还将运行备用ResourceManager。<br/>' +
      '这将允许Active-Standby ResourceManager配置自动执行故障转移。<br/><br/>' +
      '<b>启用ResourceManager HA时您应该计划群集维护窗口并为群集停机做好准备。</b>',
  'admin.rm_highAvailability.wizard.step2.header': '选择主机',
  'admin.rm_highAvailability.wizard.step2.body': '选择将要运行追加的ResourceManager的主机',
  'admin.rm_highAvailability.wizard.step3.header': '回顾',
  'admin.rm_highAvailability.wizard.step3.confirm.host.body':'<b>确认您的主机选择。</b>',
  'admin.rm_highAvailability.wizard.step3.confirm.config.body':'<div class="alert alert-info">' +
      '<p><b>查看配置变更。</b></p>' +
      '下面列出了向导将启用ResourceManager HA的配置更改，此信息<b>仅供审查</b>，不可修改。' +
      '</div>',
  'admin.rm_highAvailability.wizard.step3.currentRM': '当前的ResourceManager',
  'admin.rm_highAvailability.wizard.step3.additionalRM': '追加的ResourceManager',
  'admin.rm_highAvailability.wizard.step4.header': '配置组件',
  'admin.rm_highAvailability.wizard.step4.task0.title': '停止所需的服务',
  'admin.rm_highAvailability.wizard.step4.task1.title': '安装追加的ResourceManager',
  ...
  'admin.rm_highAvailability.wizard.step4.notice.inProgress':'正在部署ResourceManager HA中，请稍等。',
  ...
  'admin.ra_highAvailability.wizard.step1.header': '开始吧',
  'admin.ra_highAvailability.wizard.step1.body': '此向导将引导您逐步在群集上启用Ranger Admin HA。<br/>' +
      '启用后除了活动Ranger Admin之外，您还将运行备用Ranger Admin。<br/>' +
      '这将允许使用Active-Standby Ranger Admin自动执行故障转移的配置。<br/><br/>' +
      '<b>启用Ranger Admin HA时您应该计划群集维护窗口并为群集停机做好准备。</b><br/><br/>' +
      '请设置负载均衡并提供要使用的URL。 在继续之前请确保正确设置了负载均衡。' +
      '<br/><br/><div class="alert">请确保Ranger Admin和负载均衡器位于单独的主机上。</div>',
  'admin.ra_highAvailability.wizard.step1.load_balancer_url': '负载均衡的URL',
  'admin.ra_highAvailability.wizard.step1.invalid_url': '必须是有效的URL',
  'admin.ra_highAvailability.wizard.step2.header': '选择主机',
  'admin.ra_highAvailability.wizard.step2.body': '选择一个或多个将运行追加的Ranger Admin组件的主机',
  ...
  'admin.ra_highAvailability.wizard.step3.alert_message': '<b>确认您选择的主机。</b>',
  'admin.ra_highAvailability.wizard.step3.currentRA': '当前的Ranger Admin',
  'admin.ra_highAvailability.wizard.step3.additionalRA': '追加的Ranger Admin',
  'admin.rm_highAvailability.wizard.step3.configs_changes': '<p><b>回顾配置更改。</b></p>' +
      '以下列出了向导将启用Ranger Admin HA进行的配置更改。' +
      '此信息<b>仅供审查</b>，不可修改。',
  'admin.ra_highAvailability.wizard.step4.header': '安装, 启动并测试',
  'admin.ra_highAvailability.wizard.step4.task0.title': '关闭所有服务',
  'admin.ra_highAvailability.wizard.step4.task1.title': '安装追加的Ranger Admin',
  'admin.ra_highAvailability.wizard.step4.task2.title': '重新配置服务',
  'admin.ra_highAvailability.wizard.step4.task3.title': '启动所有服务',
  'admin.ra_highAvailability.wizard.step4.notice.inProgress': '正在部署Ranger Admin HA中，请稍等。',
  'admin.ra_highAvailability.wizard.step4.notice.completed': 'Ranger Admin HA已成功启用。',
  'admin.ra_highAvailability.closePopup':'启用Ranger Admin HA向导正在进行中，您必须允许向导完成才能使Ambari处于可用状态。' +
      '如果选择退出，则必须按照《Ambari用户指南》中的说明，按照手动说明完成或还原启用Ranger Admin HA。 您确定要退出向导吗？',

  'admin.nameNodeFederation.button.enable':'添加新HDFS Namespace',
  'admin.nameNodeFederation.wizard.required.zookeepers': '所有的ZooKeeper服务都应该启动',
  'admin.nameNodeFederation.wizard.required.journalnodes': '所有JournalNodes应该都已启动',
  'admin.nameNodeFederation.wizard.header': '添加新HDFS Namespace',
  'admin.nameNodeFederation.closePopup': '你确定你要退出吗？',
  'admin.nameNodeFederation.closePopup2': '<b>添加新HDFS Namespace向导</b>正在进行中，您必须允许向导完成才能使Ambari处于可用状态。如果选择退出，则必须按照手册《Ambari用户指南》中的说明完成或还原记录的“添加新HDFS Namespace”。 您确定要退出向导吗？',
  'admin.nameNodeFederation.wizard.step1.header': '开始吧',
  'admin.nameNodeFederation.wizard.step1.body':'该向导将引导您完成设置新的Highly Available NameNode对的过程，该对将用于创建新的HDFS namespace，从而允许您使用Ambari来管理多个HDFS namespace并利用HDFS联合身份验证。',
  'admin.nameNodeFederation.wizard.step1.alert':'在添加新的HDFS Namespace时，您应该计划一个集群维护窗口，并为集群停机做好准备，因为该向导将重新启动所有服务。',
  'admin.nameNodeFederation.wizard.step1.nameserviceid':'新Nameservice ID',
  'admin.nameNodeFederation.wizard.step1.nameserviceid.existing':'现有的Nameservice ID',
  'admin.nameNodeFederation.wizard.step1.nameserviceid.error':'必须唯一，并且由字母、数字和连字符组成，不能以连字符开头或结尾。',
  'admin.nameNodeFederation.wizard.step2.header': '选择主机',
  'admin.nameNodeFederation.wizard.step2.body': '选择运行{0}的NameNode的主机',
  'admin.nameNodeFederation.wizard.step3.header': '回顾',
  'admin.nameNodeFederation.wizard.step3.confirm.config.body': '<div class="alert alert-info">' +
      '<p><b>查看配置变更。</b></p>' +
      '下面列出了向导将启用NameNode Federation的配置更改，该信息<b>仅用于审查</b>，除<b>dfs.journalnode.edits.dir</b>属性外，不可编辑' +
      '</div>',
  'admin.nameNodeFederation.wizard.step4.header': '配置组件',
  'admin.nameNodeFederation.wizard,step4.save.configuration.note':'此配置由“启用NameNode Federation”向导创建',
  'admin.nameNodeFederation.wizard.step4.notice.inProgress':'正在部署新的HDFS Namespace中，请稍等。',
  'admin.nameNodeFederation.wizard.step4.notice.completed':'添加新HDFS Namespace向导已成功完成。',
  'admin.nameNodeFederation.wizard.step4.task0.title': '停止所需的服务',
  'admin.nameNodeFederation.wizard.step4.task1.title': '重新配置服务',
  'admin.nameNodeFederation.wizard.step4.task2.title': '安装追加的NameNodes',
  'admin.nameNodeFederation.wizard.step4.task3.title': '安装追加的ZKFCs',
  ...
  'admin.security.disable.popup.body': '您将在群集上禁用Kerberos，这将停止群集中的所有服务并删除Kerberos配置。<strong>您确定要继续禁用Kerberos吗？</strong>',
  'admin.security.step1.header': '开始吧',
  'admin.security.step2.header': '配置服务',
  'admin.security.step3.header': '创建Principals和Keytabs',
  'admin.security.step4.header': '保存并应用配置',
  'admin.security.step1.body.header': '重要说明：在配置Ambari来管理启用Kerberos的群集之前，' +
      '必须在群集上执行以下手动步骤，确保记录每个主机的keytab文件的位置以及每个Hadoop服务的principals。' +
      '为了使用向导，此信息是必需的。',
  'admin.security.step1.body.instruction1': '安装, 配置并启动您的Kerberos KDC',
  'admin.security.step1.body.instruction2': '在集群中的每个主机上安装并配置Kerberos客户端',
  'admin.security.step1.body.instruction3': '为Hadoop服务和主机创建Kerberos principals',
  'admin.security.step1.body.instruction4': '为每个principal生成keytabs并将其放置在适当的主机上',
  'admin.security.step1.body.instruction5': 'YARN服务的<b>Timeline Server应用程序</b>组件将被<span class="text-danger"><b>删除</b></span>，作为在此HDP版本堆栈中启用安全性的一部分',
  'admin.security.step2.body.header': '配置Kerberos安全的属性',
  'admin.security.step3.notice': '在继续之前，您需要创建Kerberos principals和keytabs。<br />'+
      '下载CSV文件并使用它创建脚本以在指定主机上生成principals和keytabs。' +
      '创建principals和keytabs后单击<i>应用</i>继续。如果需要进行配置更改，请单击<i>返回</i>。',
  'admin.security.step3.table.principal': 'Principal',
  'admin.security.step3.table.keytab': 'Keytab',
  'admin.security.step3.downloadCSV': '下载CSV',
  'admin.security.step4.body.header': '将kerberos安全应用于集群',
  'admin.security.step4.body.success.header' : '在群集上已启用基于Kerberos的安全，在安全模式下启动服务中，请稍等。',
  'admin.security.step4.body.failure.header' : '无法在群集上启用基于Kerberos的安全，您的群集将继续以非安全模式运行。',
  'admin.security.step4.save.configuration.note':'此配置由“启用/禁用”安全向导创建',
  'admin.security.apply.configuration.error' : '无法将安全配置应用于群集，请导航到“配置服务”步骤，并确保为所有服务配置了合适的值。',
  'admin.security.disable.body.header' : '在集群上禁用kerberos安全',
  'admin.security.disable.body.success.header': '在群集上已禁用基于Kerberos的安全，在非安全模式下启动服务中，请稍等。',
  'admin.security.disable.body.failure.header': '无法在群集上禁用基于Kerberos的安全，您的集群将继续以安全模式运行。',
  ...
  'admin.users.delete.yourself.message':'您无法删除您自己',
  ...
  'admin.users.createError.passwordValidation': '密码不一样',
  'admin.users.createError.userNameExists': '具有相同名称的用户已经存在',
  'admin.users.editError.requiredField': '这是必需的',

  'admin.access.showJobs':'为非管理员用户启用“Jobs”选项卡',

  'admin.confirmUninstall':'确认卸载',
  'admin.cluster.stackVersion':'集群组件栈版本',
  ...
  'admin.cluster.repositories.popup.header.success':'已保存的资源库基础URLs',
  'admin.cluster.repositories.popup.header.fail':'基础URL验证失败',
  'admin.cluster.repositories.popup.body.success':'资源库基础URL已保存成功。',
  'admin.cluster.repositories.popup.body.fail':'基础URL验证失败且没有保存。',
  'admin.cluster.repositories.invalidURLAttention': '<b>注意：</b>保存前，请确保所有资源库URL均有效。',
  'admin.cluster.repositories.emptyURLattention':'<b>注意：</b>必须先输入资源库URL，然后才能保存。',
  'admin.cluster.repositories.skipValidation.tooltip':'<b>警告：</b>这仅适用于高级用户，如果要跳过对资源库基础URL的验证，请使用此选项。',

  'admin.misc.header': '服务用户和组',
  'admin.misc.nothingToShow': '没有要显示的用户帐户',

  'admin.serviceAutoStart.title': "服务自动启动",
  'admin.serviceAutoStart.header.text': "可以将Ambari服务配置为在系统启动时自动启动。可以将每个服务配置为启动所有组件、主服务和workers，或有选择地启动。",
  'admin.serviceAutoStart.general.switcher': "自动启动设置",
  'admin.serviceAutoStart.tooltip.text': "{0}启用组件",
  ...
  'admin.stackVersions.upgrade.start.fail.title':'无法开始升级',
  ...
  'admin.stackVersions.editRepositories.info': '提供您要配置的操作系统的基础URL。',
  'admin.stackVersions.editRepositories.validation.warning': '一些资源库验证失败，如果您确定网址正确无误，请更改基础网址或跳过验证',
  ...
  'admin.stackVersions.version.linkTooltip': '单击以编辑资源库',
  'admin.stackVersions.version.hostsTooltip': '单击以列出主机',
  'admin.stackVersions.version.emptyHostsTooltip': '没有主机列出',
  ...
  'admin.stackVersions.manageVersions.popup.body': '您将离开<b>集群管理</b>界面然' +
      '后进入<b>Ambari管理</b>界面，' +
      '您可以使用“Ambari管理” > “集群”部分中的“转到仪表板”链接返回集群管理。',
  ...
  'admin.stackVersions.version.upgrade.pause': "升级：所需操作",
  'admin.stackVersions.version.upgrade.notFinalized.warning': "升级尚未完成。验证群集正常运行后，不要忘记尽快完成升级（强烈建议在几天之内完成），因为在未完成状态下运行群集会导致HDFS上的额外资源需求。",
  'admin.stackVersions.version.upgrade.running': "升级：进行中",
  'admin.stackVersions.version.upgrade.running.nonWizard': "升级：处理中 | 由{0}发起",
  ...
  'admin.stackVersions.version.downgrade.running': "降级：处理中",
  'admin.stackVersions.version.downgrade.running.nonWizard': "降级：处理中 | 由{0}发起",
  ...
  'admin.stackVersions.version.errors.outOfSync.desc': '有一个主机组件没有报告Ambari期望的版本。' +
      '请重新安装发生故障的主机组件或将其删除。',
  ...
  'admin.stackVersions.version.service.notUpgradable': "该存储库中包含的该服务的版本已安装在集群中。",
  'admin.stackVersions.version.service.notSupported': "当前版本的组件栈不支持此服务。",

  'admin.stackVersions.version.upgrade.upgradeOptions.header': "升级选项",
  'admin.stackVersions.version.upgrade.upgradeOptions.bodyMsg.version': "您将要升级到<b>{0}</b>.",
  'admin.stackVersions.version.upgrade.upgradeOptions.bodyMsg.method': "选择升级方式：",
  'admin.stackVersions.version.upgrade.upgradeOptions.bodyMsg.tolerance': "选择可选的升级故障容错：",
  ...
  'admin.stackVersions.version.upgrade.upgradeOptions.tolerance.tooltip': "这些升级容错选项在大型集群上执行升级并且您希望最大程度地减少用户干预时非常有用。",
  'admin.stackVersions.version.upgrade.upgradeOptions.RU.title': "滚动升级",
  'admin.stackVersions.version.upgrade.upgradeOptions.RU.description': "执行升级时服务将保持运行状态，干扰降到最低，但升级速度较慢。",
  'admin.stackVersions.version.upgrade.upgradeOptions.EU.title': "Express",
  'admin.stackVersions.version.upgrade.upgradeOptions.HOU.title': "主机单",
  'admin.stackVersions.version.upgrade.upgradeOptions.EU.description': "执行升级时服务将停止，导致停机但升级速度更快。",
  ...
  'admin.stackVersions.version.upgrade.upgradeOptions.EU.confirm.msg': '您即将执行<b>快速升级</b>到<b>{0}</b>，这将导致群集停机，您确定要继续吗？',
  ...
  'admin.stackVersions.version.upgrade.alertsWarning': '群集告警仍将可见并记录在Ambari中，但是在升级过程中将不显示通知（例如Email和SNMP）。',

  'admin.stackVersions.version.preUpgrade.header' : '升级前检查',
  'admin.stackVersions.version.preUpgrade.bodyMsg.version': '以下检查已经运行，以测试您升级到<b>{0}</b>的能力。',
  ...
  'admin.stackVersions.hosts.popup.header.current': "当前的",
  'admin.stackVersions.hosts.popup.header.installed': "已安装的",
  ...
  'admin.stackVersions.hosts.popup.current.title': "{0}适用于{1}主机：",
  ...
  'admin.stackVersions.upgradeHistory.show.details': '点击显示更多有关{0}的详细信息',
  ...
  'admin.stackVersions.upgradeHistory.no.history': '没有可用的升级或降级历史记录',
  ...
  'admin.stackUpgrade.preCheck.fail.message': "{0}必需的{1}",

  'admin.stackUpgrade.finalize.later': "稍后完成",
  'admin.stackUpgrade.finalize.message.upgrade': "您的集群版本已升级。" +
      "准备完成升级并提交到新版本时请单击<b>完成</b>。" +
      "强烈建议您在集群上运行测试，以确保集群在最终确定之前可以正常运行。" +
      "<b>升级完成后，您将无法返回原版本。</b>",
  'admin.stackUpgrade.finalize.message.downgrade': "您的群集版本已降级。" +
      "当您准备完成降级并提交到新版本时请单击<b>完成</b>。" +
      "强烈建议您在集群上运行测试，以确保集群在最终确定之前可以正常运行。" +
      " <b>降级完成后，您将无法返回到原版本。</b>",
  'admin.stackUpgrade.finalize.message.revertible': "The <b>{0}</b>升级到<b>{1}</b>即可完成。" +
      "完成修补后，如果不再需要该修补程序，则可以从“版本栈”页面还原该补丁程序。",
  'admin.stackUpgrade.finalize.message.autoStart': "如果您禁用了自动启动以进行升级，请记住重新启用它。",
  'admin.stackUpgrade.finalize.message.skippedServiceChecks': "在升级过程中，以下服务的检查失败并被跳过：",
  ...
  'admin.stackUpgrade.failedHosts.options.first': "<b>暂停升级</b>, 删除不正常的主机，然后返回到继续升级向导。",
  'admin.stackUpgrade.failedHosts.options.second': "执行<b>降级</b>, 它将所有主机还原到以前的版本栈。",
  'admin.stackUpgrade.failedHosts.options.third': "暂时忽略这些失败和<b>继续</b>（稍后再对失败进行调解）。",
  ...
  'admin.stackUpgrade.doThisLater': "稍后处理",
  'admin.stackUpgrade.pauseUpgrade': "暂停升级",
  'admin.stackUpgrade.pauseDowngrade': "暂停降级",
  'admin.stackUpgrade.pauseUpgrade.warning': "您将暂停{0}，您可以返回继续{0}并在以后完成操作，但是在暂停升级时您<strong style='color:red;'>不应该</strong>执行任何群集更改，例如：" +
      "<ul><li>请勿添加/删除群集上的主机</li>" +
      "<li>请勿添加/删除群集上的服务</li>" +
      "<li>请勿启用/禁用Kerberos</li>" +
      "<li>请勿启用/禁用HA</li>" +
      "<li>请勿对服务配置进行任何重大更改</li></ul>" +
      "您<strong>必须</strong>继续执行{0}并最终确定<strong>之前</strong>对集群执行<strong>任何</strong>的重大更改。",
  'admin.stackUpgrade.downgrade.proceed': "继续降级",
  'admin.stackUpgrade.downgrade.body': "您确定要中止升级过程并降级到<b>{0}</b>吗？",
  'admin.stackUpgrade.downgrade.retry.body': "您确定要降级到<b>{0}</b>",
  'admin.stackUpgrade.upgrade.confirm.body': "您将要升级到{0}。",
  'admin.stackUpgrade.upgrade.retry.confirm.body': "您将重试升级到{0}。",
  'admin.stackUpgrade.title': "版本栈",
  'admin.stackUpgrade.state.inProgress': "正在进行升级",
  'admin.stackUpgrade.state.paused': "升级暂停",
  'admin.stackUpgrade.state.aborted': "升级中断",
  ...
  'admin.stackUpgrade.state.aborted.downgrade': "降级中断",
  ...
  'admin.stackUpgrade.dialog.skipped.failures':'自动跳过失败的步骤，在继续升级之前请解决每个故障。',
  'services.service.start':'启动',
  'services.service.stop':'停止',
  'services.service.allComponents':'所有组件',
  'services.service.metrics':'指标',
  'services.nothingToAdd':'没什么可补充的',
  'services.service.summary.version':'版本',
  'services.service.summary.viewHost':'查看主机',
  'services.service.summary.viewHosts':'查看主机(多)',
  'services.service.summary.clientOnlyService.ToolTip':'仅限客户的服务',
  'services.service.summary.mapreduce2.client':'MapReduce2客户端',
  'services.service.summary.mapreduce2.clients':'MapReduce2客户端(s)',
  'services.service.summary.nodeManagersLive':'NodeManagers Live',
  'services.service.summary.TrackersLive':'Trackers Live',
  'services.service.summary.PhoenixServersLIVE':'Phoenix Query servers Live',
  'services.service.summary.GangliaMonitorsLIVE':'Ganglia Monitors Live',
  ...
  'services.service.summary.nameNodeHeap':'NameNode组件',
  ...
  'services.service.summary.pendingUpgradeStatus.notPending':'无未完成的升级',
  ...
  'services.service.summary.trackersBlacklistGraylist':'Trackers',
  'services.service.summary.jobTrackerHeap':'JobTracker Heap',
  'services.service.summary.totalSlotsCapacity':'总Slots容量',
  ...
  'services.service.summary.tasksReduces':'Tasks: Reduces',
  'services.service.summary.hbaseMaster':'HBase Master Web UI',
  'services.service.summary.regionServerCount':'RegionServer数目',
  'services.service.summary.regionInTransition':'Region In Transition',
  'services.service.summary.masterStarted':'Master已启动',
  'services.service.summary.masterActivated':'Master活跃的',
  'services.service.summary.averageLoad':'平均负荷',
  'services.service.summary.masterHeap':'Master Heap',
  'services.service.summary.moreStats':'这有更多统计数据',
  'services.service.summary.clientCount': '{0}客户端主机',
  'services.service.summary.historyServer': 'History Server Web UI',
  'services.service.summary.hiveserver2.jdbc.url.text': ' JDBC URL',
  'services.service.summary.hiveserver2.endpoint.tooltip.text':'{0}的JDBC 连接字符串',
  'services.service.summary.hiveserver2.endpoint.value':'jdbc:hive2://{0}/;serviceDiscoveryMode={1};zooKeeperNamespace={2}',
  ...
  'services.service.actions.run.rebalanceHdfsNodes':'重平衡HDFS',
  ...
  'services.service.actions.run.rebalanceHdfsNodes.promptError':'值应介于1到100之间',
  'services.service.actions.run.rebalanceHdfsNodes.context':'重平衡HDFS',
  ...
  'services.service.actions.run.updateHBaseReplication.label': '启动/更新HBase Replication',
  'services.service.actions.run.updateHBaseReplication.context': '启用HBase跨集群复制功能',
  'services.service.actions.run.updateHBaseReplication.title': 'HBase Replication：启动/更新',
  'services.service.actions.run.updateHBaseReplication.promptError': 'ZKQuorum节点间以`,`分隔。端口和Peer ID应该是数字',
  'services.service.actions.run.updateHBaseReplication.zkquorumText.prompt': 'Peer Cluster ZK Quorum：',
  'services.service.actions.run.updateHBaseReplication.zkportText.prompt': 'Peer Cluster ZK端口：',
  'services.service.actions.run.updateHBaseReplication.parentzkeyText.prompt': '父ZKey for HBase：',
  'services.service.actions.run.updateHBaseReplication.peerIdText.prompt': 'Peer Cluster ID：',
  'services.service.actions.run.updateHBaseReplication.error':'设置HBase跨集群复制时出错',
  'services.service.actions.run.stopHBaseReplication.label': '停止HBase Replication',
  'services.service.actions.run.stopHBaseReplication.context': '禁用HBase跨集群复制',
  'services.service.actions.run.stopHBaseReplication.title': 'HBase Replication：停止',
  'services.service.actions.run.stopHBaseReplication.promptError': 'Peer ID应为数字',
  'services.service.actions.run.stopHBaseReplication.error': '禁用HBase跨集群复制时出错',
  'services.service.actions.run.stopHBaseReplication.prompt': '要从Replication Peer列表中移除的Peer集群ID：',

  // Hive Server Interactive custom command to restart LLAP
  'services.service.actions.run.restartLLAP':'重启LLAP',
  'services.service.actions.run.immediateStopHawqService.context':'启动HAWQ服务（立即模式）',
  ...
  'services.service.actions.run.immediateStopHawqSegment.context':'停止HAWQ Segment（立即模式）',
  ...
  'services.service.actions.hsi.alertPopup.body':'您现在无法启用交互式查询，因为交互式查询正在被禁用。这可能需要几分钟的时间，稍后再试。',

  'services.service.delete.popup.header': '删除服务',
  'services.service.delete.popup.kerberos': 'Kerberos服务<i>无法删除</i>，' +
      '因为当前启用了Kerberos并且群集正在使用Kerberos服务。只能通过禁用Kerberos来删除Kerberos服务，' +
      '这可以通过浏览至<b>Ambari > Kerberos </b>并选择<b>禁用Kerberos</b> 来找到。',
  'services.service.delete.popup.ranger': '删除<b>Ranger</b>之前必须禁用插件。',
  'services.service.delete.configVersionNote': '删除{0}之后更新配置',
  'services.service.delete.configVersionNote.plural': '删除{0}之后更新配置',
  'services.service.delete.lastService.popup.body': '<b>{0}</b>服务无法删除，必须至少安装一个服务。',
  'services.service.delete.popup.dependentServices': '在删除<b>{0}</b>之前必须删除以下依赖服务：',
  'services.service.delete.popup.mustBeStopped': '在删除<b>{0}</b>之前必须停止服务和每个从组件和主组件。',
  'services.service.delete.popup.mustBeStopped.dependent': ' 以及相关服务<b>{0}</b>。',
  'services.service.delete.popup.warning': '{0}服务将从Ambari中删除，所有配置' +
      '和配置历史记录都将丢失。</b>',
  'services.service.delete.popup.warning.dependent': '<b> 注意：相关的{0}服务也将被删除。</b>',
  'services.service.confirmDelete.popup.header': '确认删除',
  'services.service.confirmDelete.popup.body': '您必须通过在确认框中键入“{1}”来确认删除<b>{0}</b>，' +
      '<b>此操作不可逆，并且所有配置历史记录都将丢失。</b>',
  ...
  'services.service.confirmDelete.popup.body.dependent': '您必须通过在确认框中键入“{2}”来确认删除<b>{0}</b>和<b>{1}</b>，' +
      '<b>此操作不可逆，并且所有配置历史记录都将丢失。</b>',
  'services.service.delete.progressPopup.message': '删除{0}中...',
  ...
  'services.service.delete.popup.warning.ranger_kms': '<b>如果加密区（EZ）和密钥由服务管理，则不应删除Ranger KMS，否则将无法访问EZ中的数据。</b>',
  ...
  'services.service.summary.ranger.plugin.loadingStatus': '加载状态中...',
  ...
  'services.service.info.metrics.ambariMetrics.regionServer.displayNames.storeFilesCount': 'StoreFiles数',
  'services.service.info.metrics.ambariMetrics.regionServer.regions': 'Regions数',
  'services.service.info.metrics.ambariMetrics.regionServer.displayNames.regionsCount': 'Regions数',
  ...
  'services.service.info.metrics.ambariMetrics.regionServer.blockCacheHitPercent': 'Block Cache命中百分比',
  'services.service.info.metrics.ambariMetrics.regionServer.displayNames.blockCacheHitPercent': 'Block Cache命中百分比',
  ...
  'services.service.info.metrics.flume.channelFillPercent':'Channel Fill百分比',
  'services.service.info.metrics.flume.channelSize':'Channel大小',
  'services.service.info.metrics.flume.sinkDrainSuccess':'Sink事件流出计数',
  'services.service.info.metrics.flume.sourceAccepted':'Source事件接受计数',
  'services.service.info.metrics.flume.sinkConnectionFailed':'Sink连接失败计数',
  'services.service.info.metrics.flume.channelSizeMMA':'Channel Size Events',
  'services.service.info.metrics.flume.channelSizeSum':'Channel Size Event总和',
  'services.service.info.metrics.flume.incoming.mma':'传入事件比率',
  'services.service.info.metrics.flume.incoming.sum':'传入事件总和',
  'services.service.info.metrics.flume.outgoing.mma':'输出事件比率',
  'services.service.info.metrics.flume.outgoing.sum':'输出事件总和',
  ...
  'services.service.info.metrics.hbase.hlogSplitSize':'HLog Split大小',
  'services.service.info.metrics.hbase.hlogSplitSize.displayNames.splitSize':'Split大小',
  'services.service.info.metrics.hbase.hlogSplitTime':'HLog Split时间',
  'services.service.info.metrics.hbase.hlogSplitTime.displayNames.splitTime':'Split时间',
  ...
  'services.service.info.metrics.hdfs.blockStatus':'Block状态',
  'services.service.info.metrics.hdfs.blockStatus.displayNames.pendingReplicationBlocks':'挂起的副本Blocks',
  'services.service.info.metrics.hdfs.blockStatus.displayNames.underReplicatedBlocks':'副本Blocks',
  ...
  'services.service.info.metrics.hdfs.jvmThreads.displayNames.threadsTimedWaiting':'定时等待的线程',
  ...
  'services.service.info.metrics.hdfs.spaceUtilization.displayNames.capacityNonDFSUsed':'已用非DFS容量',
  ...
  'services.service.info.metrics.yarn.jvmThreads.displayNames.threadsWaiting':'等待的线程',
  'services.service.info.metrics.yarn.jvmThreads.displayNames.threadsTimedWaiting':'定时等待的线程',
  ...
  'services.service.info.metrics.yarn.gc': 'GC',
  ...
  'services.service.info.metrics.yarn.nodemanager.statuses':'NodeManagers',
  'services.service.info.metrics.yarn.nodemanager.statuses.displayNames.active':'活动的NodeManagers',
  'services.service.info.metrics.yarn.nodemanager.statuses.displayNames.decommissioned':'退服的NodeManagers',
  ...
  'services.service.info.metrics.yarn.queueMemoryResource':'队列内存已使用',
  ...
  'services.service.info.metrics.yarn.apps.states.failed': '失败的',
  'services.service.info.metrics.yarn.apps.states.killed': 'Killed',
  'services.service.info.metrics.yarn.apps.states.pending': '待定的',
  'services.service.info.metrics.yarn.apps.states.running': '运行中的',
  'services.service.info.metrics.yarn.apps.states.submitted': '提交的',
  ...
  'services.service.config.password.additionalDescription': '为了安全起见，密码更改将不会显示在配置版本对比中',
  'services.service.config.secure.additionalDescription': '特权用户可以从“管理”选项卡下的“Kerberos”页面更改此配置。',
  'services.service.config.saved':'保存配置变更',
  'services.service.config.notSaved':'无法保存配置变更',
  'services.service.config.restartService.TooltipMessage':'<b>重启服务</b><br>在{1}主机上的{0}组件使用的配置过期：{2}',
  ...
  'services.service.config.msgServiceStop':'无法保存配置更改，请先停止服务。所有组件停止运行后，您将能够保存配置更改。',
  'services.service.config.failCreateConfig' : '创建服务配置失败',
  'services.service.config.failSaveConfig':'保存服务配置失败',
  'services.service.config.failSaveConfigHostOverrides':'保存服务配置失败',
  ...
  'services.service.config.addPropertyWindow.error.derivedKey.specific':'此配置文件中已经定义了属性“{0}”',
  'services.service.config.addPropertyWindow.error.format':'Key和value应该以"="分割',
  ...
  'services.service.config.stopService.unknownHostComponents':'{1}主机上的{0}组件状态未知，这些组件可能实际上正在运行，并且需要稍后重新启动才能使更改生效。',
  'services.service.config.confirmDirectoryChange':'您将要更改{0}核心的服务目录，在继续之前，请绝对确定其中的含义，并且已对更改进行了必要的手动步骤（如果有）。您确定要继续吗？',
  ...
  'services.service.config.exitChangesPopup.body':'返回上一步将导致您丢失所有当前的自定义设置。您确定吗？',
  ...
  'services.service.config.connection.exitPopup.msg': '测试连接正在进行中，建议等到完成为止，您确定要退出启用Kerberos向导吗？',
  ...
  'services.service.config.database.msg.jdbcSetup': '确保你已经运行了：<br/>' +
      'Ambari Server主机上执行 <b>ambari-server setup --jdbc-db={0} --jdbc-driver=/path/to/{0}/{1}</b> ' +
      '，使JDBC驱动程序可用，并启用对数据库连接的测试。',
  ...
  'services.service.config.setRecommendedValue': '设为推荐的',
  'services.service.config.database.msg.jdbcSetup.detailed': '要将{0}与{6}一起使用您必须, 你必须<a rel="noopener noreferrer" href="{3}" target="_blank">' +
      '从{0}下载{4}</a>，下载到Ambari服务器主机后运行：<br/>' +
      '<b>ambari-server setup --jdbc-db={1} --jdbc-driver=/path/to/{1}/{2}</b>',

  'services.service.widgets.list-widget.nothingSelected': '没有选择',

  'services.add.header':'添加服务向导',
  'services.add.warning': '添加服务向导正在进行中，您真的要退出“添加服务向导”吗？',
  'services.add.warningStep6': '关闭此对话框将继续在后台安装选定的服务，但是需要手动启动已安装的服务，您确定你要退出吗？',
  ...
  'services.service.restartAllRequired':'重启所有必要服务',
  ...
  'services.service.refreshAll.confirmMsg': '<p>您将要重新启动{0}</p>' +
      '<div class="alert alert-warning">重新启动服务时这将触发告警，若要取消告警，请在运行“重新启动所有必需项”之前为上面列出的服务打开“维护模式”。</div>',
  ...
  'services.service.stop.warningMsg.turnOnMM': '服务停止时，这将生成告警，要禁止显示告警，请在停止之前打开“{0}”的“维护模式”。',
  'services.service.stopCertain.warningMsg.turnOnMM': '这将在组件停止时生成告警，要禁止显示告警，请在停止之前打开“{0}”的“维护模式”',
  'services.service.stop.warningMsg.dependent.services': '停止{0}可能会削弱其相关服务的功能：{1}。',
  'services.service.restartAll.confirmButton': '确认重启所有',
  'services.service.restartAll.confirmMsg': '您即将重启{0}',
  'services.service.restartAll.warningMsg.turnOnMM': '重新启动服务时，这将触发告警，要禁止显示告警，请在运行“重新启动全部”之前打开{0}的“维护模式”',
  'services.service.restartCertain.warningMsg.turnOnMM': '这将在组件重新启动时触发告警，要禁止显示告警，请在运行“重新启动全部”之前打开{0}的“维护模式”',
  'services.service.componentsInNameSpace': '{0} namespace中的组件',
  'services.service.stop.HDFS.warningMsg.checkPointNA': '无法确定最后一个HDFS检查点的使用期限，请确保您有一个最近的检查站。否则NameNode可能需要很长时间才能启动。',
  ...
  'services.service.stop.HDFS.warningMsg.checkPointTooOld.instructions':
      ...
      '<div class="code-snippet">sudo su {0} -l -c \'hdfs dfsadmin -saveNamespace\'</div></li>' +
      '</ol>',
  'services.service.stop.HDFS.warningMsg.checkPointTooOld': '最后的HDFS checkpoint早于{0}小时。',
  'services.service.stop.HDFS.warningMsg.checkPointTooOld.makeSure': '在继续操作之前，请确保已采取checkpoint，否则NameNode可能需要很长时间才能启动。',
  'services.service.stop.HDFS.warningMsg.nameSpaces.checkPointTooOld': '对于以下namespaces最后的HDFS checkpoint早于{0}小时：',
  'services.service.config_groups_popup.header':'管理{0}配置组',
  'services.service.config_groups_popup.notice':'您可以通过管理{{serviceName}}配置组及其主机成员身份，将不同的{{servicename}}配置集应用于主机组。属于{{serviceName}}配置组的主机具有{{serviceName}}相同的配置集，每个主机都属于一个{{serviceName}}配置组。',
  'services.service.config_groups_popup.rename':'重命名',
  'services.service.config_groups_popup.duplicate':'副本',
  ...
  'services.reassign.closePopup':'移动{0}向导正在进行中，您必须允许向导完成才能使Ambari处于可用状态。如果您选择退出，则必须按照《Ambari用户指南》中的说明完成或还原移动{0}向导的手动说明。您确定要退出向导吗？',
  'services.reassign.error.fewHosts':'群集中必须至少有2台主机才能运行“移动向导”。',

  'services.reassign.step1.header':'开始创建',
  'services.reassign.step1.message1': '这个向导将引导您通过移动{0}。<br/>',
  ...
  'services.reassign.step2.header':'分配主服务',
  ...
  'services.reassign.step3.configs':'<div class="alert alert-info">' +
      '<p><b>审查配置改变。</b></p>该向导将进行以下配置更改。</div>',
  ...
  'services.reassign.step4.tasks.save.configuration.note':'此配置由“移动{0}”向导创建',
  ...
  'services.reassign.step4.tasks.testDBConnection.tooltip':'数据库主机：{0}\n' +
      ...
      'JDBC Driver Class：{5}\n' +
      '数据库URL：{6}',
  'services.reassign.rollback.confirm':'您确定吗？',
  ...
  'services.reassign.step4.save.configuration.note':'此配置由“移动{0}”向导创建',
  ...
  'services.reassign.step4.tasks.startNewMySqlServer.title':'启动新MYSQL服务',
  'services.reassign.step4.status.success': '已将<b>{0}</b>从<b>{1}</b>主机成功移至<b>{2}</b>主机',
  'services.reassign.step4.status.success.withManualSteps': '继续下一步',
  'services.reassign.step4.status.failed': '无法将<b>{0}</b>从<b>{1}</b>主机成功移至<b>{2}</b>主机',
  'services.reassign.step4.status.info': '重新分配{0}。\n请等待所有任务完成。',
  'services.reassign.step4.retry': '您可以单击“重试”或“中止”按钮重试失败的任务或中止变更',
  'services.reassign.step4.abortError': '中止更改时出错。',
  'services.reassign.step5.header': '手动命令',
  'services.reassign.step5.body.namenode':
      '<div class="alert alert-info">' +
      '<ol>' +
      '<li>将源主机<b>{1}</b>中<b>{0}</b>的内容复制到目标主机<b>{2}</b>。</li>' +
  ...
  'services.reassign.step5.body.namenode_ha':
      ...
      '<li>通过运行以下命令在ZooKeeper中重置自动故障转移信息：' +
      '<div class="code-snippet">sudo su {3} -l -c \'hdfs zkfc -formatZK\'</div></li>' +
      '</ol>' +
      '</div>' +
      '<div class="alert alert-info">' +
      ...
      '<div class="alert alert-warning"><strong>重要！</strong>请确保登录到新安装的NameNode主机。<br>这与上述步骤1和2是不同的主机。</div>' +
      '</li>' +
      '<li>通过运行以下命令初始化元数据：' +
      "<div class='code-snippet'>sudo su {3} -l -c 'hdfs namenode -bootstrapStandby'</div></li>" +
      '</ol>' +
  ...
  'services.reassign.step5.body.secondary_namenode':
      '<div class="alert alert-info">' +
      '<ol>' +
      '<li>将源主机<b>{1}</b>上<b>{0}</b>的内容复制到<b>目标主机<b>{2}</b>上的{0}</b>。</li>' +
      '<li>登录目标主机<b>{2}</b>并更改SNameNode的权限，通过运行以下命令：' +
      '<div class="code-snippet">chown -R {3}:{5} {6}</div></li>' +
      '</ol>' +
      '</div>',
  'services.reassign.step5.body.oozie_server':
  ...
  'services.reassign.step5.body.mysql_server':
      '<div class="alert alert-info">' +
      '<ol>' +
      '<li>在<b>{1}</b>上您可以使用以下终端导出Metastore DB（MYSQL）：' +
      '<div class="code-snippet">mysqldump db_name > backup-file.sql</div></li>' +
      '<li>将文件复制到托管MySQL数据库的目标主机<b>{2}</b></li>' +
      '<li>在<b>mysql<b>中执行：' +
      '<div class="code-snippet">CREATE DATABASE db_name;</div></li>' +
      '<li>使用以下命令导入数据库' +
      '<div class="code-snippet">mysql db_name < backup-file.sql</div></li>' +
  ...
  'services.reassign.step5.body.app_timeline_server': '<div class="alert alert-info">' +
      '<ol>' +
      '<li>将<b>{7}/{8}</b>从源主机<b>{1}</b>复制到<b>{7}/{8}</b>在目标主机<b>{2}</b>上。</li>' +
      '<li>登录到目标主机<b>{2}</b>并通过运行以下命令来更改权限：' +
      '<div class="code-snippet">chown -R {3}:{5} {7}/{8}</div></li>' +
      '<div class="code-snippet">chmod -R 700 {7}/{8}</div></li>' +
      '</ol>' +
      '</div>',
  'services.reassign.step5.body.securityNotice': '<div class="alert alert-info"> <div class="alert alert-warning"> <strong>注意：</strong>安全集群' +
      '需要为重新分配的组件生成必要的principals，并使用在主体上的principal创建keytab目标主机。' +
      '服务用户应该可以访问keytab文件。</div> {0} </div>',
  'services.reassign.step5.body.securityConfigsList': '使用principal<b>{1}</b>在<b>{2}</b>主机上创建keytab文件<b>{0}</b>。',
  'services.reassign.step5.body.proceedMsg': '完成上述步骤后，请继续',
  'services.reassign.step5.confirmPopup.body': '在继续操作之前，请确认您已经执行了手动步骤。',
  ...
  'services.reassign.step6.status.success': '已将<b>{0}</b>从<b>{1}</b>主机成功移至<b>{2}</b>主机。',
  'services.reassign.step6.status.failed': '无法将<b>{0}</b>从<b>{1}</b>主机成功移至<b>{2}</b>主机。',
  ...
  'service.hbase.activeMaster': '活跃Master',

  'services.hive.client': 'Hive客户端',
  'services.hive.clients': 'Hive客户端(s)',

  'services.falcon.client': 'Falcon客户端',
  'services.falcon.clients': 'Falcon客户端(s)',

  'services.oozie.client': 'Oozie客户端',
  'services.oozie.clients': 'Oozie客户端(s)',
  'services.oozie.webUi': 'Oozie Web UI',
  ...
  'services.zookeeper.clients': 'ZooKeeper客户端(s)',
  'services.zookeeper.client': 'ZooKeeper客户端',

  'services.mapreduce2.history.running': 'History server正在运行中',
  'services.mapreduce2.history.stopped': 'History server停止了',
  'services.mapreduce2.history.unknown': 'History server状态未知',
  'services.mapreduce2.smokeTest.requirement': 'MapReduce2 smoke测试要求YARN服务是启动的',

  'services.tez.client': 'Tez客户端',
  'services.tez.clients': 'Tez客户端(s)',
  'services.pig.client': 'Pig客户端',
  'services.pig.clients': 'Pig客户端(s)',
  'services.glusterfs.client': 'GLUSTERFS客户端',
  'services.glusterfs.clients': 'GLUSTERFS客户端(s)',
  'services.sqoop.client': 'Sqoop客户端',
  'services.sqoop.clients': 'Sqoop客户端(s)',

  'services.hbase.master.error':'没有HBase masters处于活动状态',

  'alerts.actions.manage_alert_groups_popup.header':'管理告警组',
  'alerts.actions.manage_alert_groups_popup.notice':'您可以在此对话框中管理每个服务的告警组，查看告警组列表以及在其中配置的告警定义。' +
      '您还可以添加/删除告警定义，并为该告警组选择通知。',
  ...
  'alerts.actions.manage_alert_groups_popup.addGroup.exist': '告警组给定名称已经存在',
  ...
  'alerts.actions.manage_alert_groups_popup.addDefinition.noDefinitions':'没有告警定义可显示',
  'alerts.actions.manage_alert_groups_popup.addDefinition':'将告警定义添加到选定的告警组',
  'alerts.actions.manage_alert_groups_popup.addDefinitionDisabled':'没有可用的告警定义可添加',
  'alerts.actions.manage_alert_groups_popup.addDefinitionToDefault': '无法修改默认告警组',
  'alerts.actions.manage_alert_groups_popup.removeDefinition':'从选定的告警组中删除告警定义',
  ...
  'alerts.actions.manage_alert_groups_popup.selectDefsDialog.selectedDefsLink': '从{1}个告警定义中选择了{0}个',
  'alerts.actions.manage_alert_groups_popup.selectDefsDialog.message.warning': '至少需要选择一个告警定义。',

  'alerts.actions.manage_alert_notifications_popup.header':'管理告警通知',
  'alerts.actions.manage_alert_notifications_popup.noAlertNotification':'未定义告警通知',
  ...
  'alerts.actions.manage_alert_notifications_popup.email':'Email收件人',
  'alerts.actions.manage_alert_notifications_popup.SMTPServer':'SMTP服务',
  ...
  'alerts.actions.manage_alert_notifications_popup.error.name.existed': '通知名已存在',
  ...
  'hosts.filters.filteredHostsInfo': '{1}台主机中的{0}台在显示',

  'hosts.filters.selectedHostInfo': '主机选择',
  'hosts.filters.selectedHostsInfo': '选定的主机',
  ...
  'hosts.bulkOperation.confirmation.hosts':'您确定要在以下{1}个主机上<strong>{0}</strong>吗？',
  'hosts.bulkOperation.confirmation.delete.hosts':'您确定要删除以下{0}个主机吗？',
  'hosts.bulkOperation.confirmation.hostComponents':'您确定要在以下{2}个主机上<strong>{0} {1}</strong>吗？',
  'hosts.bulkOperation.passiveState.nothingToDo.body':'您选择的所有主机都已经处于维护模式。',
  'hosts.bulkOperation.warningInfo.body':'这些主机上的组件已停止，因此将跳过退服。',
  ...
  'hosts.bulkOperation.confirmation.add.component.nothingToDo.body': '所有选择的主机都已经安装了{0}。',
  'hosts.bulkOperation.confirmation.cannot.add1': '以下主机将被跳过（扩容的原因）：',
  'hosts.bulkOperation.confirmation.cannot.add2': '{0}无法添加到以下主机（扩容的原因）：',
  ...
  'hosts.bulkOperation.deleteHosts.lastMasterComponents': '群集不包含以下主组件的任何其它实例：{0}',
  'hosts.bulkOperation.deleteHosts.runningComponents': '以下组件正在运行中需要停止：{0}',
  'hosts.bulkOperation.deleteHosts.confirm.header':'确认批量删除主机',
  'hosts.bulkOperation.deleteHosts.confirm.delete': '以下主机将被删除：',
  'hosts.bulkOperation.deleteHosts.cannot.delete1':'以下主机将被跳过（扩容的原因）：',
  'hosts.bulkOperation.deleteHosts.cannot.delete2':'所选主机无法删除（扩容的原因）',
  'hosts.bulkOperation.deleteHosts.confirmation.header':'确认批量删除主机',
  'hosts.bulkOperation.deleteHosts.confirmation.body.msg1': '<b>请注意：</b>一旦删除Ambari将忽略来自这些主机的将来的通信。作为删除过程的一部分将不会删除软件包，因此一旦从Ambari中删除了服务请不要尝试在主机上手动启动服务。如果您希望将主机重新添加到群集中，请在尝试添加主机之前彻底清理主机。',
  'hosts.bulkOperation.deleteHosts.confirmation.body.msg2': '为了确保将其从Ambari数据库中完全删除,',
  'hosts.bulkOperation.deleteHosts.confirmation.body.msg3': '请确保在这些主机上Ambari Agent进程已完全停止，然后再继续。',
  'hosts.bulkOperation.deleteHosts.result.header':'删除主机',
  'hosts.bulkOperation.deleteHosts.result.body': '以下主机已成功删除：',
  'hosts.bulkOperation.confirmation.delete.component.cannot1': '以下主机将被跳过（扩容的原因）：',
  'hosts.bulkOperation.confirmation.delete.component.cannot2': '{0}无法从所选主机中删除：',
  ...
  'hosts.bulkOperation.confirmation.delete.component.nothingToDo.notStopped': '{0}尚未在所有选定主机上停止',
  'hosts.bulkOperation.confirmation.delete.component.nothingToDo.notInstalled': '未在任何选定主机中安装{0}',
  'hosts.bulkOperation.confirmation.delete.component.skip':'以下主机将被跳过',
  ...
  'hosts.bulkOperation.delete.component.dryRun.message':'无法从以下主机中删除{0}（扩容的原因）',
  ...
  'hosts.selectHostsDialog.message': '选择应属于此{0}配置组的主机，属于该组的所有主机将具有相同的配置集。',
  ...
  'hosts.host.serviceNotAvailable': '该主机上不可用的服务',
  ...
  'hosts.host.stackVersions.outOfSync.tooltip': '此版本在此主机上不同步。' +
      '安装未使用的版本后，主机上的组件可能会发生不同步的更改。' +
      '单击“安装”以让Ambari安装该版本的软件包，以使该主机同步。',
  ...
  'hosts.host.metrics.load.displayNames.load_fifteen':'15分钟的负载',
  'hosts.host.metrics.load.displayNames.load_one':'1分钟的负载',
  'hosts.host.metrics.load.displayNames.load_five':'5分钟的负载',
  ...
  'hosts.host.metrics.network.displayNames.pkts_out':'出包',
  'hosts.host.metrics.network.displayNames.bytes_in':'字节输入',
  'hosts.host.metrics.network.displayNames.bytes_out':'字节输出',
  'hosts.host.metrics.network.displayNames.pkts_in':'入包',
  ...
  'hosts.host.details.hostActions':'主机执行',
  ...
  'hosts.host.deleteComponent.popup.deleteJournalNodeMsg': '您将打开<i>管理Journal Node向导</i>，您确定吗？',
  'hosts.host.deleteComponent.popup.warning':'<b>警告！</b>删除群集中的最后一个<i>{0}</i> 组件？</br>删除群集中的最后一个组件可能会导致服务数据永久丢失。',
  ...
  'host.host.addComponent.popup.dependedComponents.body': '{0}要求将{1}与其一起安装在同一主机上，请先添加它们然后尝试添加{0}',
  ...
  'hosts.host.zooKeeper.configs.save.note': '该配置由Ambari在主机上安装/删除Zookeeper组件时创建',
  'hosts.host.addComponent.securityNote':'您正在以安全模式运行群集，在继续之前必须为{1}上的{0}设置密钥标签。否则，该组件将无法正常启动。',
  'hosts.host.addComponent.popup.confirm':'确认添加',
  'hosts.host.manualKerberosWarning': '<strong>由于已在群集上手动安装了Kerberos，因此完成此操作后，您将必须创建/分发principals和keytabs。</strong>',
  ...
  'hosts.host.storm.configs.save.note': '该配置由Ambari在主机上安装/删除Storm组件时创建',
  'hosts.host.datanode.decommission':'退服DataNode',
  'hosts.host.datanode.recommission':'入服DataNode',
  'hosts.host.nodemanager.decommission':'退服NodeManager',
  'hosts.host.nodemanager.recommission':'入服NodeManager',
  'hosts.host.tasktracker.decommission':'退服TaskTracker',
  'hosts.host.tasktracker.recommission':'入服TaskTracker',
  'hosts.host.tasktracker.restart':'重启TaskTracker',
  'hosts.host.regionserver.decommission.batch1':'退服RegionServer - 开启drain模式',
  'hosts.host.regionserver.decommission.batch2':'退服RegionServer - 停止RegionServer',
  'hosts.host.regionserver.decommission.batch3':'退服RegionServer - 关闭drain模式',
  'hosts.host.hbase_regionserver.recommission':'入服RegionServer',
  'hosts.host.hbase_regionserver.decommission':'退服RegionServer',
  'hosts.host.hbase_regionserver.decommission.warning':'无法停用最后一个RegionServer',
  'hosts.host.decommissioned':'退服的',
  'hosts.host.decommissioning':'退服中',
  'hosts.host.addComponent.JOURNALNODE': '您将打开<i>“管理Journal Node向导”</i>。您确定吗？',
  ...
  'hosts.host.deleteComponent.popup.deleteWebHCatServer':'您将要删除<i>WebHCat Server</i>。确定吗？',
  'hosts.host.configs.save.note': '该配置由Ambari在主机上安装/删除{0}组件时创建',

  'hosts.component.passive.implied.host.mode.tooltip':'无法关闭维护模式，因为主机处于维护模式',
  'hosts.component.passive.implied.service.mode.tooltip':'{0}处于维护模式，无法关闭维护模式',
  ...
  'hosts.host.alert.noAlerts.message':'该主机没有告警。',
  'hosts.host.healthStatus.heartBeatNotReceived':'服务器超过3分钟没有收到来自此主机的心跳信号。',
  'hosts.host.healthStatus.mastersDown':"以下主组件已关闭：\n",
  'hosts.host.healthStatus.slavesDown':"以下从组件出现故障：\n",
  'hosts.host.healthStatus.allUp':'所有组件都装好了',
  'hosts.host.healthStatusCategory.green': "健康的",
  'hosts.host.healthStatusCategory.red': "主服务宕机",
  'hosts.host.healthStatusCategory.orange': "从服务宕机",
  ...
  'hosts.host.maintainance.removeFailedComponents.context': '移除失败的组件',
  ...
  'hosts.host.alerts.st':'&nbsp;！&nbsp;',
  'hosts.decommission.popup.body':'您确定吗？',
  ...
  'hosts.delete.popup.body.msg1':'通过删除此主机，Ambari将忽略此主机的将来通信，软件包不会从主机中删除，主机上的组件不应重新启动。如果您希望将此主机重新加入群集，请确保清理主机。',
  'hosts.delete.popup.body.msg3':'如果此主机托管了Zookeeper服务器则应重新启动Zookeeper服务。跳转到<i>服务</i>页面。',
  'hosts.delete.popup.body.msg4':'<b>警告！</b>删除集群中的最后一个<i>{0}</i>组件吗？</br>删除集群中的最后一个组件可能会导致服务数据永久丢失。',
  'hosts.delete.popup.body.msg5':'<b>警告！</b>代理仍在心跳，因此主机仍将存在于数据库中。',
  'hosts.delete.popup.body.msg6':'要完全删除主机，请先在其上停止ambari-agent。',
  'hosts.delete.popup.body.msg7':'<b>警告！</b>{0}应该首先停用，以防止数据丢失。',
  'hosts.delete.popup.body.msg.unknownComponents':'该主机似乎不在线，并且与该代理的Ambari通信已丢失。',
  'hosts.delete.popup.header':'确认',
  'hosts.delete.popup.title':'删除主机',
  'hosts.delete.popup.unknownComponents':'以下组件有未知的状态：',
  'hosts.recover.popup.title': '确认',
  'hosts.recover.popup.body': '该操作将完全在此主机上重新安装所有组件。<strong>您确定要继续吗？<strong>',
  'hosts.recover.error.popup.title': '无法恢复主机',
  'hosts.recover.error.popup.body': '除非每个组件都已停止否则无法恢复该主机，请停止所有组件，然后重试。',
  'hosts.cant.do.popup.title':'无法删除主机',
  'hosts.cant.do.popup.masterList.body':'该主机具有以下主要组件，因此无法删除：',
  'hosts.cant.do.popup.masterList.body.end':'要删除此主机，必须首先移动（移除）上面列出的所有主要组件。',
  'hosts.cant.do.popup.nonDeletableList.body':'不支持删除以下{0}个组件。',
  'hosts.cant.do.popup.runningList.body':'由于正在运行以下组件，因此无法删除该主机：',
  'hosts.cant.do.popup.runningList.body.end':'要删除此主机，必须首先停止上面列出的所有正在运行的组件。' +
      '如果该主机具有{0}，则应先将其停用，以防止数据丢失。',
  'hosts.cant.do.popup.lastMasterList.body':'无法删除此主机，因为以下主组件没有任何其它实例：',
  'hosts.cant.do.popup.lastMasterList.body.end':'要删除此主机，必须首先将上面列出的所有组件添加到其它主机',
  'hosts.add.header':'添加主机向导',
  'hosts.add.exit.header':'退出',
  'hosts.add.exit.body':'您真的要退出“添加主机向导”吗？',
  'hosts.assignRack':'分配机架',
  'hosts.checkHost.popup':'您确定要<b>检查主机</b>中的{0}吗？',
  'hosts.passiveMode.popup':'您确定要为{1}<b>打开{0}维护模式</b>吗？',
  'hosts.passiveMode.popup.version.mismatch': '{0}具有来自堆栈的非当前组件，在将此主机退出维护模式之前，建议您将其组件升级到{1}',
  'hosts.passiveMode.popup.version.mismatch.multiple': '某些主机的堆栈中的组件不是最新的。在使这些主机退出维护模式之前，建议您将它们的组件升级到{0}',
  ...
  'charts.heatmap.item.host.process':'总运行线程',
  'charts.heatmap.category.hdfs':'HDFS',
  'charts.heatmap.category.yarn': 'YARN',
  'charts.heatmap.category.hbase': 'HBase',
  ...
  'dashboard.clusterMetrics.cpu':'CPU使用情况',
  ...
  'dashboard.button.reset': '重置所有默认小部件 ',
  'dashboard.widgets.actions.title': 'Metric操作',
  ...
  'dashboard.widgets.browser.action.added': '增加的',
  ...
  'dashboard.widgets.browser.action.share.confirmation': '您将使它成为共享的窗口小部件，所有集群操作员都将能够修改或删除此小部件。您确定要共享此小部件吗？',
  'dashboard.widgets.browser.shareIcon.tooltip': 'Shared',
  'dashboard.widgets.browser.action.delete.shared.bodyMsg': '您将永久删除<b>{0}</b>小部件。' +
      '此窗口小部件是共享窗口小部件，此操作将从共享窗口小部件库中删除该窗口小部件，并从所有用户中删除该窗口小部件。' +
      '<br /> <br /> <b>确定要永久删除此共享窗口小部件吗？</b>',
  'dashboard.widgets.browser.action.delete.mine.bodyMsg': '您将永久删除 <b>{0}</b>小部件。' +
      '此操作将从您的窗口小部件库中删除该窗口小部件。<br /><br /><b>您确定要永久' +
      '删除此窗口小部件吗？</b>',
  'dashboard.widgets.browser.action.delete.btnMsg': '确定删除',
  ...
  'dashboard.widgets.HDFSLinks': 'HDFS连接',
  'dashboard.widgets.HDFSLinks.activeNameNode': '活跃的NameNode',
  'dashboard.widgets.HDFSLinks.standbyNameNode': '备用的NameNode',
  'dashboard.widgets.HDFSLinks.standbyNameNodes': '2个备用NameNodes',
  'dashboard.widgets.HBaseLinks': 'HBase连接',
  ...
  'dashboard.widgets.YARNLinks': 'YARN连接',
  'dashboard.widgets.YarnContainers': 'YARN容器',
  'dashboard.widgets.error.invalid': '取消的！输入一个介于{0} - {1}',
  ...
  'dashboard': {
    'widgets': {
      ...
      'hintInfo': {
        ...
        'hint1': '编辑阈值百分比以更改当前窗口小部件的颜色<br/>假定所有组件UP为100，所有DOWN为0。<br/>因此输入0至{0}之间的两个数字',
        'hint2': '编辑阈值以更改当前窗口小部件的颜色。<br/> <br/>，因此输入两个大于0的数字。',
        'hint3': '编辑阈值以更改当前窗口小部件的颜色。<br/>单位为毫秒，<br/>因此输入两个大于0的数字。',
        'hint4': '编辑代表减少的{0}数量的阈值以更改小部件的颜色。<br/>如果{0}下降的数目大于阈值，则该小组件将以红色显示警告。<br/>选择0到{1}之间的数字。'
      }
    }
  },
  ...
  'dashboard.services.uptime':'{0}',
  'dashboard.services.summary.slaves.live': 'Live',
  'dashboard.services.hdfs.summary':'{0}的{1}节点存活，{2}%容量使用',
  ...
  'dashboard.services.hdfs.capacity.dfsUsed':'磁盘使用情况（DFS已用的）',
  'dashboard.services.hdfs.capacity.nonDfsUsed':'磁盘使用情况（非DFS使用的）',
  ...
  'dashboard.services.hdfs.nodes.decom':'停运',
  'dashboard.services.hdfs.nodes.uptime':'NameNode正常运行时间',
  'dashboard.services.hdfs.nodes.heap':'NameNode堆',
  'dashboard.services.hdfs.nodes.heapUsedPercent':'{0}%',
  'dashboard.services.hdfs.nodes.heapUsed':'{0} / {1}',

  'dashboard.services.hdfs.chart.label':'容量（已用/总数）',
  'dashboard.services.hdfs.blockErrors.total': '共',
  ...
  'dashboard.services.hdfs.datanode.status.tooltip.live': '这是从NameNode报告的活动的DataNode数。' +
      '即使DataNode进程已启动，如果DataNode未按预期与NameNode通信，' +
      'NameNode也会将其视为死亡状态。' +
      '这可能是由于过度GC导致的网络问题或DataNode进程挂起等情况。',
  'dashboard.services.hdfs.datanode.status.tooltip.dead': '这是从NameNode报告的已死的DataNode数。' +
      '即使DataNode进程已启动，如果DataNode未按预期与NameNode通信，' +
      'NameNode也会将其视为已死状态。' +
      '这可能是由于过度GC导致的网络问题或DataNode进程挂起等情况。',
  'dashboard.services.hdfs.datanode.status.tooltip.decommission': '这是从NameNode报告的当前正在退服的DataNode的数量。' +
      '如果集群中没有足够的其它DataNode' +
      '来创建基于dfs.replication属性（通常为3）的配置数量的block副本，' +
      '则DataNode可能会处于停用状态，' +
      '直到NameNode可以使用更多的DataNode。',

  'dashboard.services.yarn.summary':'{1}个节点中的{0}个处于存活状态',
  'dashboard.services.yarn.resourceManager':'ResourceManager',
  'dashboard.services.yarn.nodeManagers':'NodeManagers',
  'dashboard.services.yarn.nodeManager':'NodeManager',
  'dashboard.services.yarn.nodes.heapUsed':'{0} / {1}',
  'dashboard.services.yarn.nodes.heapUsedPercent':'{0}%',
  'dashboard.services.yarn.clients':'YARN客户端(s)',
  'dashboard.services.yarn.client':'YARN客户端',
  'dashboard.services.hdfs.clients':'HDFS客户端(s)',
  'dashboard.services.hdfs.client':'HDFS客户端',
  'dashboard.services.yarn.resourceManager.uptime':'ResourceManager正常运行时间',
  'dashboard.services.yarn.resourceManager.active':'活跃的ResourceManager',
  'dashboard.services.yarn.resourceManager.standby':'备份的ResourceManager',
  ...
  'dashboard.services.yarn.nodeManagers.status.decommissioned': '退服的',
  ...
  'dashboard.services.yarn.nodeManagers.status.tooltip.lost': '这是从ResourceManager报告的丢失的NodeManager的数量。' +
      '即使NodeManager进程启动，如果NodeManager未按预期与ResourceManager通信，则ResourceManager仍可能会看到状态已丢失。' +
      '这可能是由于诸如网络问题或由于GC过多而导致NodeManager进程挂起之类的情况造成的。',
  'dashboard.services.yarn.nodeManagers.status.tooltip.unhealthy': '这是从ResourceManager报告的不正常的NodeManager的数量。',
  'dashboard.services.yarn.nodeManagers.status.tooltip.rebooted': '这是ResourceManager报告的处于重新启动状态的NodeManager的数量。',
  'dashboard.services.yarn.nodeManagers.status.tooltip.decommissioned': '这是从ResourceManager报告的退服的NodeManager的数量。',
  ...
  'dashboard.services.yarn.memory.used': '已用',
  ...
  'dashboard.services.flume.summary.title':'将Flume安装在{0}主机{1}（{2}代理{3}上）',
  ...
  'dashboard.services.hbase.summary':'{0}个平均负载为{1}的region servers',
  'dashboard.services.hbase.masterServer':'HBase Master',
  'dashboard.services.hbase.masterServer.active':'活跃的HBase Master',
  'dashboard.services.hbase.masterServer.standby':'备用的HBase Master',
  'dashboard.services.hbase.noMasterServer':'无活跃的Master',
  'dashboard.services.hbase.masterServerHeap':'Master堆',
  'dashboard.services.hbase.masterServerHeap.summary':'{0} / {1}',
  'dashboard.services.hbase.masterServerHeap.percent':'{0}%',
  'dashboard.services.hbase.masterServerUptime':'Master服务正常运行时间',
  'dashboard.services.hbase.averageLoad':'平均负载',
  'dashboard.services.hbase.averageLoadPerServer':'{0} regions/RS',
  'dashboard.services.hbase.regionServers':'RegionServers',
  'dashboard.services.hbase.regionServersSummary':'{0} live / {1} total',
  'dashboard.services.hbase.phoenixServers':'Phoenix Query Servers',
  'dashboard.services.hbase.phoenixServersSummary':'{0} live / {1} total',
  ...
  'dashboard.services.hbase.masterWebUI':'Master Web UI',
  'dashboard.services.hbase.regions.transition':'Regions In Transition',
  'dashboard.services.hbase.masterStarted':'Master启动的',
  'dashboard.services.hbase.masterActivated':'Master活动的',
  ...
  'dashboard.configHistory.table.notes.addService': '添加服务时配置已更新',
  'dashboard.configHistory.table.notes.no': '',
  'dashboard.configHistory.table.version.versionText' : 'V{0}',
  'dashboard.configHistory.table.version.prefix' : 'V',
  ...
  'dashboard.configHistory.info-bar.authoredOn': '创作于',
  'dashboard.configHistory.info-bar.changesToHandle': '变更处理',
  ...
  'dashboard.configHistory.info-bar.save.popup.placeholder': '您变更了什么？',
  'dashboard.configHistory.info-bar.save.popup.warningForPasswordChange': '此配置更改包括密码更改。密码更改将被保存，但出于安全目的，密码更改将不会显示在配置版本对比中。',
  ...
  'dashboard.configHistory.info-bar.view.button.disabled': '您当前正在查看该版本。',
  'dashboard.configHistory.info-bar.compare.button.disabled': '您无法与相同版本进行比较。',
  'dashboard.configHistory.info-bar.revert.button.disabled': '这是当前版本。',
  'dashboard.configHistory.info-bar.compare.tooltip': '将此版本与当前版本进行对比',
  ...
  'tableView.filters.filteredAlertInstancesInfo': '{0}/{1}实例显示',
  'tableView.filters.filteredLogsInfo': '{0}/{1}日志显示',
  ...
  'rollingrestart.dialog.msg.noRestartHosts': '没有{0}可以进行滚动重启',
  ...
  'rollingrestart.dialog.msg.toleration.prefix': '容错高达 ',
  ...
  'rollingrestart.dialog.warn.datanode.batch.size': '不建议一次重启多个DataNode。这样做可能会导致数据不可用并且或者将数据主动写入HDFS的可能丢失。',
  'rollingrestart.dialog.msg.serviceNotInMM':'注意：这将触发告警。要禁止显示告警，请在触发滚动重启之前为{0}启用“维护模式”',
  'rollingrestart.dialog.msg.staleConfigsOnly': '仅用旧配置重新启动{0}',
  'rollingrestart.rest.context': '{0}的滚动重启-{2}的批次{1}',
  'rollingrestart.context.allOnSelectedHosts':'重启所选主机上的所有组件',
  'rollingrestart.context.configs.allOnSelectedHosts':'刷新选定主机上的所有配置',
  'rollingrestart.context.allForSelectedService':'重启{0}的所有组件',
  'rollingrestart.context.allWithStaleConfigsForSelectedService':'使用{0}的旧配置重启所有组件',
  'rollingrestart.context.ClientOnSelectedHost':'重新启动{1}上的{0}',
  'rollingrestart.context.allWithStaleConfigsOnSelectedHost':'在{0}上使用旧配置重启组件',
  ...
  'service.restart.choose.text': '请选择应该执行的重启类型。',
  'service.rolling.restart.choose.info': '升级过程中关键业务仍在运行。</br>最小的中断，但是是一个较慢的升级。',
  'service.express.restart.choose.info': '升级过程中业务停止。</br>导致停机，但是是一个更快的升级。',
  'service.restart.show.advanced.info': '显示高级配置选项<p style="font-size: 12px; color: #999999; display: inline;">（按批次/主机重启、重启间隔等。）</p>',
  'service.restart.rolling.restart.hosts.by': '重新启动主机',
  'service.restart.rolling.batchesOfHosts': '主机批量',
  'service.restart.rolling.rackByRack': '一个机架接一个机架',
  'service.restart.rolling.advanced.noOfHosts': '批量处理的主机数量',
  'service.restart.rolling.advanced.batchIntervalHosts': '批次间隔（SEC）',
  'service.restart.rolling.advanced.percentRacks': '一次启动机架的百分比',
  'service.restart.rolling.advanced.batchIntervalRacks': '机架间间隔（SEC）',
  'service.restart.rolling.advanced.automatic.retry': '自动重试失败的主机',
  'service.restart.rolling.advanced.noOfRetries': '每台主机的重试次数',
  'service.restart.rolling.advanced.max.failures.tolerated': '允许的最大故障<p style="font-size: 11px;">（达到阈值后，重启进程挂起）</p>',
  'service.restart.rolling.advanced.max.failures.batch': '每批允许的最大故障',
  'service.restart.rolling.advanced.max.failures.rack': '每机架最大故障容忍',
  'service.restart.rolling.advanced.suppress.alerts': '在滚动重启时抑制告警',
  'service.restart.rolling.advanced.pause.after.first': '第一批后暂停',

  'rolling.command.context': '滚动设置{0}声明为"{1}" - {3}的批次{2}',
  'rolling.nothingToDo.header': '无可做的',
  'rolling.nothingToDo.body': '选定主机上的{0}已处于选定状态或处于维护模式。',

  'widget.type.gauge.description': '显示可以以百分比表示的指标视图。',
  'widget.type.number.description': '显示指标视图，该指标可以表示为带有可选单位字段的单个数字。',
  'widget.type.graph.description': '用于显示可以在一个时间范围内以折线图或面积图表示的指标视图。',
  'widget.type.template.description': '显示指标值和模板文本的视图。',
  'widget.create.wizard.header': '创建小部件',
  'widget.create.wizard.step1.header': '选择类型',
  'widget.create.wizard.step1.body.text': '您要创建哪种类型的小部件？',
  ...
  'widget.create.wizard.step2.body.text':'使用任何指标和有效运算符定义表达式。</br>在必要时使用括号。',
  'widget.create.wizard.step2.body.template':'使用任意数量的表达式和任意字符串定义模板。通过使用双花括号将其名称括起来，可以从模板中引用该表达式。',
  'widget.create.wizard.step2.body.warning':'注意：有效的运算符为 +, -, *, /',
  'widget.create.wizard.step2.body.invalid.label': '名称无效。仅允许使用字母数字、下划线、连字符、百分号和空格。',
  'widget.create.wizard.step2.body.invalid.expression':'表达式不完整或无效！',
  'widget.create.wizard.step2.body.invalid.expression2':'无效的表达！',
  'widget.create.wizard.step2.body.invalid.msg2':'在此字段中仅允许使用数字或运算符。',
  'widget.create.wizard.step2.body.template.invalid.msg':'存在无效的表达式名称。应使用带有两个大括号的名称"Expression#"。',
  'widget.create.wizard.step2.addExpression': '添加表达式',
  'widget.create.wizard.step2.addDataset': '添加数据集',
  'widget.create.wizard.step2.body.gauge.overflow.warning':'溢出！指标只能显示0到1之间的数字。',
  ...
  'widget.create.wizard.step3.name.invalid.msg': '窗口小部件名太长。请输入少于129个字符的窗口小部件名。',
  'widget.create.wizard.step3.name.invalidCharacter.msg': '无效的窗口小部件名。仅允许使用字母数字、下划线、连字符、百分号和空格。',
  'widget.create.wizard.step3.description.invalid.msg': '说明太长。请输入少于2049个字符的描述。',
  'widget.create.wizard.step3.description.invalidCharacter.msg': '输入无效。仅允许使用字母数字、下划线、连字符、百分号和空格。',

  'widget.edit.wizard.header': '编辑小部件',

  'widget.clone.body': '您确定要克隆当前的小部件<b>{0}</b>吗？',
  'widget.edit.body': '这是一个共享的窗口小部件，所做的编辑将为所有用户更改此窗口小部件。您是否愿意克隆小部件？',
  ...
  'dashboard.widgets.wizard.step2.aggregateTooltip': '此数学函数将应用于为所有主机组件中的所选指标计算单个值',
  ...
  'dashboard.widgets.wizard.onClose.popup.body': '您有未保存的更改，如果您在此步骤中退出向导，则所做的更改将不会保存。',
  ...
  'jobs.nothingToShow': '没有要显示的jobs',
  'jobs.error.ats.down': '由于YARN Timeline Server未运行，因此无法显示作业数据。',
  ...
  'jobs.customDateFilter.error.laterThanNow':'指定的时间是将来的时间',
  ...
  'number.validate.notValidNumber': '不是一个有效数字',
  ...
  'common.combobox.dropdown.final': '最后的属性',
  ...
  'contact.administrator': '请与系统管理员联系以获取更多信息！',
  ...
  'config.group.selection.dialog.option.select.msg': '属于所选组的主机的“覆盖”属性将更改。',
  'config.group.selection.dialog.option.create': '创建一个新的{0}配置组',
  'config.group.selection.dialog.option.create.msg': '将使用给定名称创建一个新的{0}配置组。最初该组中将没有主机，只有选定的属性会被覆盖。',
  ...
  'config.group.save.confirmation.msg': '点击<em>管理主机</em>以管理配置组的主机成员身份',
  ...
  'config.group.description.default': '在{0}上创建了新的配置组',
  ...
  'errorMessage.config.number.integer': '必须仅包含数字',
  ...
  'errorMessage.config.password.length': '密码至少应包含{0}个符号',
  'errorMessage.config.directory.heterogeneous': '目录格式错误，可以为"[{storage type}]/{dir name}"',
  'errorMessage.config.directory.default': '开始必须是斜杠或驱动器，并且不能包含空格',
  'errorMessage.config.directory.allowed': '无法以"home(s)"开头',
  'errorMessage.config.spaces.trailing': '尾部不能包含空格',
  'errorMessage.config.spaces.trim': '不能包含前置或尾部空格',
  ...
  'wizard.inProgress': '{0}进行中 | 由{1}发起',

  'alerts.instance.fullLogPopup.header': '实例响应',
  'admin.addHawqStandby.button.enable': '添加HAWQ备用主服务',
  'admin.addHawqStandby.closePopup':'“添加HAWQ备用主服务向导”正在进行中，' +
      '您必须允许向导完成才能使Ambari处于可用状态。如果您选择退出，' +
      '则必须遵循记录的手动说明来完成或还原添加HAWQ备用主服务。您确定要退出向导吗？',
  'admin.addHawqStandby.wizard.header': '添加HAWQ备用主服务向导',
  'admin.addHawqStandby.wizard.step1.header': '开始吧',
  'admin.addHawqStandby.wizard.step1.body':'该向导将引导您完成添加HAWQ备用主服务作为当前HAWQ主服务主机的备份的进程。' +
      '添加HAWQ备用主服务后，它用作<i>热备份</i>，' +
      '如果主HAWQ主服务主机无法运行，则可以激活它。<br/><br/>' +
      '<b>此过程将重新启动HAWQ服务。在计划的群集维护窗口中执行此过程。</b>',
  'admin.addHawqStandby.wizard.step2.header': '选择主机',
  'admin.addHawqStandby.wizard.step2.body': '选择将运行HAWQ备用主服务的主机',
  ...
  'admin.addHawqStandby.wizard.step3.confirm.config.body':'<p class="alert alert-info">' +
      '<p><b>审查配置更改。</b></p>' +
      '下面列出了向导将添加HAWQ备用主服务进行的配置更改。' +
      '此信息<b>仅供审查</b>且不可编辑。</div>',
  'admin.addHawqStandby.wizard.step3.hawqMaster': '当前HAWQ主服务',
  'admin.addHawqStandby.wizard.step3.newHawqStandby': '新HAWQ备用主服务',
  'admin.addHawqStandby.wizard.step3.confirm.dataDir.title': 'HAWQ备用主服务目录确认',
  'admin.addHawqStandby.wizard.step3.confirm.dataDir.body': '在完成此过程之前，如果存在请确保' +
      '已将HAWQ备用主服务主机<b>{0}</b>上的目录<b>{1}</b>重命名（例如,' +
      '将其变更为{0}_old）。<br/><br/><b>如果HAWQ备用主服务主机上存在{0}, ' +
      '则新的HAWQ备用主服务可能会以旧数据启动，从而使群集处于不一致状态。</b><br/><br/>' +
      '单击“确认”以表示您已重命名HAWQ备用主服务主机<b>{1}</b> 上任何现有的<b>{0}</b>目录。',
  'admin.addHawqStandby.step4.save.configuration.note': '此配置由添加HAWQ备用向导创建',
  'admin.addHawqStandby.wizard.step4.header': '配置组件',
  'admin.addHawqStandby.wizard.step4.task0.title': '停止HAWQ服务',
  'admin.addHawqStandby.wizard.step4.task1.title': '安装HAWQ备用主服务',
  'admin.addHawqStandby.wizard.step4.task2.title': '重新配置HAWQ',
  'admin.addHawqStandby.wizard.step4.task3.title': '启动HAWQ服务',
  'admin.addHawqStandby.wizard.step4.notice.inProgress':'正在部署HAWQ备用主服务中，请稍等。',
  'admin.addHawqStandby.wizard.step4.notice.completed':'HAWQ备用主服务已添加成功。',
  'admin.removeHawqStandby.button.enable': '移除HAWQ备用服务',
  'admin.removeHawqStandby.wizard.header': '移除HAWQ备用服务向导',
  'admin.removeHawqStandby.wizard.step1.header': '开始吧',
  'admin.removeHawqStandby.wizard.step1.body':'如果HAWQ备用主服务主机发生故障或维护，此向导将引导您完成删除HAWQ备用主服务的进程。' +
      '删除HAWQ备用主服务后，现有HAWQ主服务将在没有备份的情况下以独立模式运行。' +
      '<br/><br/><b>此过程将停止并重新启动HAWQ服务。仅在HAWQ主服务正常运行时，' +
      '才在计划的集群维护窗口中执行此过程。</b>' +
      '<br/><br/>完成此向导后，HAWQ群集将不再具有备用主服务。' +
      '最佳做法是，使用“添加HAWQ备用主服务”服务操作为群集配置新的HAWQ备用主服务。',
  'admin.removeHawqStandby.wizard.step2.header': '回顾',
  'admin.removeHawqStandby.wizard.step2.hawqStandby': '<b>当前HAWQ备用：</b>',
  'admin.removeHawqStandby.wizard.step2.confirm.config.body':'<div class="alert alert-info">' +
      '<p><b>查看配置更改。</b></p>在删除HAWQ备用主服务之后，向导将从hawq-site.xml中删除' +
      'hawq_standby_address_host属性。最佳做法是，在向导完成后，应配置新的HAWQ备用主服务主机。</div>',
  'admin.removeHawqStandby.wizard.step2.confirm.host.body':'<b>查看HAWQ备用主服务角色更改。</b>',
  'admin.removeHawqStandby.wizard.step2.confirmPopup.body': '您是否要继续删除HAWQ备用主服务？请确认然后再继续操作，因为您将无法从Ambari回滚。',
  'admin.removeHawqStandby.wizard.step3.header': '完成安装',
  'admin.removeHawqStandby.wizard.step3.task0.title': '移除HAWQ备用',
  ...
  'admin.removeHawqStandby.closePopup':'删除HAWQ备用向导正在进行中。' +
      '您必须允许向导完成才能使Ambari处于可用状态。' +
      '如果选择退出，则必须遵循手动说明才能回到稳定状态。您确定要退出向导吗？',
  'admin.removeHawqStandby.wizard.step3.notice.inProgress':'移除HAWQ备用主服务中，请稍等',
  'admin.removeHawqStandby.wizard.step3.notice.completed':'HAWQ备用主服务已移除成功。',
  'admin.removeHawqStandby.wizard.step3.removeHawqStandbyCommand.context': '执行HAWQ备用主服务移除命令',
  'admin.removeHawqStandby.wizard.step3.save.configuration.note': '此配置由“移除HAWQ备用”向导创建',
  'admin.activateHawqStandby.button.enable': '启用HAWQ备用主服务',
  'admin.activateHawqStandby.wizard.header': '启用HAWQ备用主服务向导',
  'admin.activateHawqStandby.wizard.step1.header': '开始吧',
  'admin.activateHawqStandby.wizard.step1.body': '如果HAWQ主服务主机发生故障，' +
      '此向导将引导您完成激活HAWQ备用主服务的过程。激活HAWQ备用主服务之后，' +
      '它会升级为新的HAWQ主服务，并且将从群集中删除以前的HAWQ主服务配置。' +
      '此过程将重新启动HAWQ服务。' +
      '除非当前的HAWQ主服务无法正常运行，否则请在计划的群集维护窗口中执行此过程。' +
      '完成此向导后，HAWQ群集将不再具有备用主服务。' +
      '最佳做法是，' +
      '使用“添加HAWQ备用主服务”服务操作为群集配置新的HAWQ备用主服务。',
  'admin.activateHawqStandby.wizard.step2.header': '回顾',
  'admin.highAvailability.wizard.step2.toBeDeleted': '被删除',
  'admin.activateHawqStandby.wizard.step2.hawqMaster': '<b>当前的HAWQ主服务：</b>',
  'admin.activateHawqStandby.wizard.step2.hawqStandby': '<b>当前的HAWQ备用主服务：</b>',
  'admin.activateHawqStandby.wizard.step2.toBeActivated': '被新的HAWQ主服务激活',
  'admin.activateHawqStandby.step4.save.configuration.note': '此配置是通过激活HAWQ备用向导创建',
  'admin.activateHawqStandby.wizard.step2.confirm.config.body': '<div class="alert alert-info">' +
      '<p><b>查看配置更改。</b></p>向导将进行以下配置更改。'+
      '此信息仅供参考，不能进行编辑。<br/><br/><b>激活HAWQ备用主服务后，' +
      '向导会从hawq-site.xml中删除hawq_standby_address_host属性。</b> ' +
      '最好实际中，您应该在向导完成后配置新的HAWQ备用主服务主机。</div>',
  'admin.activateHawqStandby.wizard.step2.confirm.host.body':'<b>查看HAWQ主服务和备用主服务角色更改。</b>',
  'admin.activateHawqStandby.wizard.step2.confirmPopup.body': '您是否要继续激活HAWQ备用主服务？' +
      '请确认然后再继续操作，因为您将无法从Ambari回滚。',
  'admin.activateHawqStandby.wizard.step3.header': '完成安装',
  'admin.activateHawqStandby.wizard.step3.task0.title': '激活HAWQ备用主服务',
  'admin.activateHawqStandby.wizard.step3.task1.title': '停止HAWQ服务',
  'admin.activateHawqStandby.wizard.step3.task2.title': '重新配置HAWQ',
  'admin.activateHawqStandby.wizard.step3.task3.title': '安装角色：新的HAWQ主服务',
  'admin.activateHawqStandby.wizard.step3.task4.title': '删除角色：先前的HAWQ主服务',
  'admin.activateHawqStandby.wizard.step3.task5.title': '删除角色：先前的HAWQ备用服务',
  'admin.activateHawqStandby.wizard.step3.task6.title': '启动HAWQ服务',
  'admin.activateHawqStandby.closePopup':'激活HAWQ备用向导正在进行中。' +
      '您必须允许向导完成才能使Ambari处于可用状态。' +
      '如果选择退出，则必须遵循手动说明才能回到稳定状态。您确定要退出向导吗？',
  'admin.activateHawqStandby.wizard.step3.notice.inProgress':'HAWQ备用主服务正在激活中，请稍等',
  'admin.activateHawqStandby.wizard.step3.notice.completed':'HAWQ备用主服务已成功激活。',
  'admin.activateHawqStandby.wizard.step3.activateHawqStandbyCommand.context': "执行HAWQ备用主服务激活命令",
  'admin.serviceAutoStart.save.popup.title': '保存自动启动配置',
  'admin.serviceAutoStart.save.popup.body': '您正在更改自动启动配置。' +
      '单击<b>保存</b>提交更改，或单击<b>放弃</b>还原您的更改',
  'admin.serviceAutoStart.save.popup.transition.title': '警告',
  'admin.serviceAutoStart.save.popup.transition.body': '您有未保存的变更',

  'reset.ui.states': '重置UI状态',
  'reset.ui.states.body': '仅当UI行为异常（例如登录时导航不正确，UI卡住且无法加载等）时，才应继续操作。您确定要重置UI状态吗？',

  'app.logger.ajax': 'Ajax加载时间：{0} [{1}]',
  'app.logger.wizard': '向导步骤{0}的加载时间'
